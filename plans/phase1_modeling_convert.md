...
- Inputs collected
  - output_folder: `mindone/transformers/models/olmo3`

- Immediate checks
  - Verify `mindone/transformers/models/olmo3` exists (create later if needed)

- Scope
  - Read all Python files under `mindone/transformers/models/olmo3/modeling_olmo3.py`
...
- Process
  ...
  - Save edits in-place under `mindone/transformers/models/olmo3`
...
- Validation checklist
  ...
  - Quick fix of `mindone/transformers/__init__.py` for import olmo3.
