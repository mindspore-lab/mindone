"""Adapted from https://github.com/huggingface/diffusers/tree/main/tests//pipelines/flux/test_pipeline_flux_img2img.py."""
...
@ddt
class FluxImg2ImgPipelineFastTests(PipelineTesterMixin, unittest.TestCase):
    pipeline_config = [
        [
            "transformer",
    ...
    def test_flux_inference(self, mode, dtype):
        ...
        pt_pipe_cls = get_module("diffusers.pipelines.flux.pipeline_flux_img2img.FluxImg2ImgPipeline")
        ms_pipe_cls = get_module("mindone.diffusers.pipelines.flux.pipeline_flux_img2img.FluxImg2ImgPipeline")
