"""Adapted from https://github.com/huggingface/diffusers/tree/main/tests//pipelines/flux/test_pipeline_flux_control.py."""
...
class FluxControlPipelineFastTests(PipelineTesterMixin, unittest.TestCase):
    ...
    def test_inference(self, mode, dtype):
        ...
        pt_pipe_cls = get_module("diffusers.pipelines.flux.pipeline_flux_control.FluxControlPipeline")
        ms_pipe_cls = get_module("mindone.diffusers.pipelines.flux.pipeline_flux_control.FluxControlPipeline")
