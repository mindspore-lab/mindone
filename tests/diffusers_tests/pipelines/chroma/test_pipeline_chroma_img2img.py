...
pipelines/chroma/test_pipeline_chroma_img2img.py.
"""
...
@ddt
class ChromaImg2ImgPipelineFastTests(PipelineTesterMixin, unittest.TestCase):
    pipeline_config = [
        [
            "transformer",
    ...
    def test_chroma(self, mode, dtype):
        ...
        pt_pipe_cls = get_module("diffusers.pipelines.chroma.pipeline_chroma_img2img.ChromaImg2ImgPipeline")
        ms_pipe_cls = get_module("mindone.diffusers.pipelines.chroma.pipeline_chroma_img2img.ChromaImg2ImgPipeline")
