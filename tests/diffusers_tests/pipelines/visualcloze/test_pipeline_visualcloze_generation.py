...
from mindone.diffusers import VisualClozeGenerationPipeline
...
@slow
@ddt
class VisualClozeGenerationPipelineIntegrationTests(unittest.TestCase):
    @data(*test_cases)
    @unpack
    def test_inference(self, mode, dtype):
        ...
        expected_image = load_numpy_from_local_file(
            ...
            f"visualcloze_generation_{dtype}.npy",
