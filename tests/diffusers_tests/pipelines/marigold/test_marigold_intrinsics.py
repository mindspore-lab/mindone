...
@ddt
class MarigoldIntrinsicsPipelineFastTests(PipelineTesterMixin, unittest.TestCase):
    pipeline_config = [
        [
            "scheduler",
    ...
    def get_dummy_components(self, time_cond_proj_dim=None):
        ...
        components["prediction_type"] = ("intrinsics", "intrinsics")
    ...
    def _test_marigold_intrinsics(self, generator_seed, mode, dtype, **pipe_kwargs):
        ms.set_context(mode=mode)

        pt_components, ms_components = self.get_dummy_components()
        pt_pipe_cls = get_module("diffusers.pipelines.marigold.MarigoldIntrinsicsPipeline")
        ms_pipe_cls = get_module("mindone.diffusers.pipelines.marigold.MarigoldIntrinsicsPipeline")
