...
class QwenImageEditPipelineFastTests(PipelineTesterMixin, unittest.TestCase):
    ...
    def test_inference(self, mode, dtype):
        ...
        pt_pipe_cls = get_module("diffusers.pipelines.qwenimage.QwenImageEditPipeline")
        ms_pipe_cls = get_module("mindone.diffusers.pipelines.qwenimage.QwenImageEditPipeline")
