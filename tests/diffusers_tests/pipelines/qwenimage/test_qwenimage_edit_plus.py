...
class QwenImageEditPlusPipelineFastTests(PipelineTesterMixin, unittest.TestCase):
    ...
    def test_inference(self, mode, dtype):
        ...
        pt_pipe_cls = get_module("diffusers.pipelines.qwenimage.QwenImageEditPlusPipeline")
        ms_pipe_cls = get_module("mindone.diffusers.pipelines.qwenimage.QwenImageEditPlusPipeline")
...
@slow
@ddt
class QwenImageEditPlusPipelineIntegrationTests(PipelineTesterMixin, unittest.TestCase):
    @data(*test_cases)
    @unpack
    def test_inference(self, mode, dtype):
        if dtype == "float32":
        ...
        pipe = QwenImageEditPlusPipeline.from_pretrained(model_id, mindspore_dtype=ms_dtype)
        ...
        expected_image = load_numpy_from_local_file(
            ...
            f"qwenimage_edit_plus_{dtype}.npy",
            subfolder="qwenimage",
        )
