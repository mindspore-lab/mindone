...
from mindone.diffusers import AutoencoderKLWan, SkyReelsV2Pipeline, UniPCMultistepScheduler
...
class SkyReelsV2PipelineFastTests(PipelineTesterMixin, unittest.TestCase):
    ...
    def test_inference(self, mode, dtype):
        ...
        pt_pipe_cls = get_module("diffusers.pipelines.skyreels_v2.pipeline_skyreels_v2.SkyReelsV2Pipeline")
        ms_pipe_cls = get_module("mindone.diffusers.pipelines.skyreels_v2.pipeline_skyreels_v2.SkyReelsV2Pipeline")
...
@slow
@ddt
class SkyReelsV2PipelineIntegrationTests(PipelineTesterMixin, unittest.TestCase):
    @data(*test_cases)
    @unpack
    def test_inference(self, mode, dtype):
        if dtype == "float32":
