...
@ddt
class StableDiffusionPAGImg2ImgPipelineFastTests(PipelineTesterMixin, unittest.TestCase):
    pipeline_config = [
        [
            "unet",
    ...
    def test_pag_inference(self, mode, dtype):
        ...
        pt_pipe_cls = get_module("diffusers.pipelines.pag.pipeline_pag_sd_img2img.StableDiffusionPAGImg2ImgPipeline")
        ms_pipe_cls = get_module(
            "mindone.diffusers.pipelines.pag.pipeline_pag_sd_img2img.StableDiffusionPAGImg2ImgPipeline"
        )
