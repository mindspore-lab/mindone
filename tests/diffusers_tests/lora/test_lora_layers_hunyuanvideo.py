...
from mindone.diffusers.utils.testing_utils import floats_tensor, numpy_cosine_similarity_distance, slow
...
@slow
class HunyuanVideoLoRAIntegrationTests(PipelineTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.pipeline = HunyuanVideoPipeline.from_pretrained(
            model_id, transformer=transformer, mindspore_dtype=ms.float16
        )
