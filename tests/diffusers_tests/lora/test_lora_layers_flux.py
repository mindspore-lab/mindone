...
class FluxLoRAIntegrationTests(PipelineTesterMixin, unittest.TestCase):
    ...
    seed = 0
    pipeline = FluxPipeline.from_pretrained("black-forest-labs/FLUX.1-dev", mindspore_dtype=ms.bfloat16)
...
class FluxControlLoRAIntegrationTests(PipelineTesterMixin, unittest.TestCase):
    ...
    pipeline = FluxControlPipeline.from_pretrained("black-forest-labs/FLUX.1-dev", mindspore_dtype=ms.bfloat16)
