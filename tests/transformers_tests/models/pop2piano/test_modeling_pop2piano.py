"""Adapted from https://github.com/huggingface/transformers/tree/main/tests/models/pop2piano/test_modeling_pop2piano.py."""
...
class Pop2PianoModelTester:
    ...
    def prepare_config_and_inputs(self):
        ...
        lm_labels = ids_numpy([self.batch_size, self.decoder_seq_length], self.vocab_size) if self.use_labels else None
...
model_tester = Pop2PianoModelTester()
(
    config,
    input_ids,
    decoder_input_ids,
...
POP2PIANO_CASES = [
    [
        ...
        "mindone.transformers.Pop2PianoForConditionalGeneration",
        (config,),
        {},
        (input_ids,),
        {
