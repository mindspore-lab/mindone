"""Adapted from https://github.com/huggingface/transformers/tree/main/tests//models/glm4v/test_modeling_glm4v.py."""
...
if transformers.__version__ >= "4.57.0":
    ...
    _CASES = [
        [
            ...
            "mindone.transformers.Qwen3VLMoeForConditionalGeneration",
            (config,),
            {},
            (),
            inputs_dict,
