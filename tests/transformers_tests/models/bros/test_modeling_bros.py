...
# FIXME: Bros does not support graph mode yet, so we only test in pynative mode.
MODES = [1]
...
BROS_CASES = [
    [
        ...
        "mindone.transformers.BrosModel",
        (config,),
        {},
        (input_ids, bbox),
        {
