...
"""Testing suite for the MindSpore HunYuanDenseV1 model."""
...
if transformers.__version__ >= "4.57.0":
    ...
    class HunyuanV1DenseModelTester:
        def __init__(
            self,
            batch_size=5,
            seq_length=20,
    ...
    HUNYUANV1DENSE_CASES = [
        [
            "HunYuanDenseV1ForCausalLM",
            "transformers.HunYuanDenseV1ForCausalLM",
            "mindone.transformers.HunYuanDenseV1ForCausalLM",
            (config,),
            {},
            (),
            {
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            for case in HUNYUANV1DENSE_CASES
