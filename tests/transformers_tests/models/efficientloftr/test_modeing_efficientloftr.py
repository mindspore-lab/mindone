...
from tests.transformers_tests.models.modeling_common import ids_numpy, floats_numpy, random_attention_mask
...
_CASES = [
    [
        ...
        "transformers.EfficientLoFTRForKeypointMatching",
        "mindone.transformers.EfficientLoFTRForKeypointMatching",
        EfficientLoFTRModelTester().prepare_config_and_inputs_for_common(),
        {"keypoints": 0, "matches": 1, "matching_scores": 2},
    ],
]
