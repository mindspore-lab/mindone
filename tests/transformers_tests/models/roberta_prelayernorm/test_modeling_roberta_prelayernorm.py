...
model_tester = RobertaPreLayerNormModelTester()
(
    config,
    inputs_dict,
...
RobertaPreLayerNorm_CASES = [
    [
        "RobertaPreLayerNormModel",
        "transformers.RobertaPreLayerNormModel",
        "mindone.transformers.RobertaPreLayerNormModel",
        (config,),
        {},
        (),
        {
...
@pytest.mark.parametrize(
    ...
    [
        ...
        for case in RobertaPreLayerNorm_CASES
