...
class Siglip2VisionModelTester:
    ...
    def prepare_config_and_inputs(self):
        ...
        pixel_attention_mask = np.zeros((self.batch_size, self.seq_length), dtype=np.int64)
        ...
        spatial_shapes = np.array(spatial_shapes, dtype=np.int64)
...
class Siglip2ModelTester:
    def __init__(self, text_kwargs=None, vision_kwargs=None, is_training=True):
        ...
        self.text_model_tester = Siglip2TextModelTester(**text_kwargs)
        self.vision_model_tester = Siglip2VisionModelTester(**vision_kwargs)
    ...
    def prepare_config_and_inputs_for_common(self):
        ...
        return config, input_ids, attention_mask, pixel_values, pixel_attention_mask, spatial_shapes, False


model_tester = Siglip2ModelTester()
(
    config,
    input_ids,
    attention_mask,
...
SIGLIP_CASES = [
    [
        ...
        "mindone.transformers.Siglip2Model",
        (config,),
        {},
        (),
        {
