...
model_tester = FalconModelTester()
(
    config,
    input_ids,
    token_type_ids,
...
BERT_CASES = [
    [
        ...
        "mindone.transformers.FalconForCausalLM",
        (config,),
        {},
        (input_ids,),
        {
    ...
    [
        ...
        "transformers.FalconForSequenceClassification",
        "mindone.transformers.FalconForSequenceClassification",
        (config,),
        {},
        (input_ids,),
        {
    ...
    [
        ...
        "transformers.FalconForTokenClassification",
        "mindone.transformers.FalconForTokenClassification",
        (config,),
        {},
        (input_ids,),
        {
    ...
    [
        ...
        "mindone.transformers.FalconModel",
        (config,),
        {},
        (input_ids,),
        {
    ...
    [
        ...
        "transformers.FalconForQuestionAnswering",
        "mindone.transformers.FalconForQuestionAnswering",
        (config,),
        {},
        (input_ids,),
        {
