...
"""Testing suite for the MindSpore D-FINE model."""
...
import pytest
import torch
from transformers import DFineConfig, HGNetV2Config
    ...
    def prepare_config_and_inputs(self):
        ...
        if self.use_labels:
            ...
            for i in range(self.batch_size):
                target = {}
                target["class_labels"] = np.random.randint(low=0, high=self.num_labels, size=(self.n_targets,))
