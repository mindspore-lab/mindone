...
"""Testing suite for the Mindspore LongcatFlash model."""
import inspect
...
from mindone.transformers import LongcatFlashModel
...
class LongcatFlashModelTester(CausalLMModelTester(parent=None)):
...
model_tester = LongcatFlashModelTester()
...
LONGCATFLASH_CASES = [
    [
        ...
        "mindone.transformers.LongcatFlashModel",
        (config,),
        {},
        (),
        {
...
@pytest.mark.parametrize(
    ...
    [
        ...
        for case in LONGCATFLASH_CASES
