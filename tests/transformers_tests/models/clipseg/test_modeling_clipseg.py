...
class CLIPSegModelTester:
    def __init__(
        ...
        self.text_model_tester = CLIPSegTextModelTester(**text_kwargs)
        self.vision_model_tester = CLIPSegVisionModelTester(**vision_kwargs)
...
text_model_tester = CLIPSegTextModelTester()
text_config, text_inputs_dict = text_model_tester.prepare_config_and_inputs_for_common()

model_tester = CLIPSegModelTester()
...
CLIPSEG_CASES = [
    [
        ...
        "mindone.transformers.CLIPSegVisionModel",
        (vision_config,),
        {},
        (),
        vision_inputs_dict,
    ...
    [
        ...
        "mindone.transformers.CLIPSegTextModel",
        (text_config,),
        {},
        (),
        text_inputs_dict,
    ...
    [
        ...
        "mindone.transformers.CLIPSegModel",
        (config,),
        {},
        (),
        inputs_dict,
    ...
    [
        ...
        "mindone.transformers.CLIPSegForImageSegmentation",
        (config,),
        {},
        (
