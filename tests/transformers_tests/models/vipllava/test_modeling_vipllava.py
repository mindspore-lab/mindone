"""Adapted from https://github.com/huggingface/transformers/tree/main/tests//models/vipllava/test_modeling_vipllava.py."""
...
TEST_CASES = [
    [
        ...
        "mindone.transformers.VipLlavaForConditionalGeneration",
        (config,),
        {},
        (),
        input_dicts,
