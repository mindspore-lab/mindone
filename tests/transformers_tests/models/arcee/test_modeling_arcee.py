"""Adapted from https://github.com/huggingface/transformers/tree/main/tests//models/arcee/test_modeling_arcee.py."""
...
ARCEE_CASES = [
    [
        ...
        "mindone.transformers.ArceeModel",
        (config,),
        {},
        (input_ids,),
        {
