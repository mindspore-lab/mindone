"""Adapted from https://github.com/huggingface/transformers/tree/main/tests/models/ernie4_5_moe/test_modeling_ernie4_5_moe.py."""
...
import pytest
import torch
from transformers import Ernie4_5_MoeConfig
...
model_tester = Ernie4_5_MoeModelTester()
...
TEST_CASES = [
    [
        ...
        "mindone.transformers.Ernie4_5_MoeModel",
        (config,),
        {},
        (),
        inputs_dict,
    ...
    [
        ...
        "transformers.Ernie4_5_MoeForCausalLM",
        "mindone.transformers.Ernie4_5_MoeForCausalLM",
        (config,),
        {},
        (),
        inputs_dict,
