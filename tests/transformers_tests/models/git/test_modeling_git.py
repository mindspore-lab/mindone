...
git_vision_model = GitVisionModelTester()
vision_config, _ = git_vision_model.prepare_config_and_inputs()
model_tester = GitModelTester()
config, input_ids, input_mask, pixel_values = model_tester.prepare_config_and_inputs()

BERT_CASES = [
    [
        "GitModel",
        "transformers.GitModel",
        "mindone.transformers.GitModel",
        (config,),
        {},
        (input_ids,),
        {
