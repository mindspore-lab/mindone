...
class SplinterModelTester:
    ...
    def prepare_config_and_inputs(self):
        ...
        if self.use_labels:
            start_positions = ids_numpy([self.batch_size, self.num_questions], self.type_sequence_label_size)
            end_positions = ids_numpy([self.batch_size, self.num_questions], self.type_sequence_label_size)
            question_positions = ids_numpy([self.batch_size, self.num_questions], self.num_labels)
