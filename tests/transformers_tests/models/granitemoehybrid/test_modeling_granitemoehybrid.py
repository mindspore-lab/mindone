...
"""Testing suite for the MindSpore GraniteMoeHybrid model."""
...
model_tester = GraniteMoeHybridModelTester()
(
    config,
    input_ids,
    attention_mask,
...
GRANITEMOEHYBRID_CASES = [
    [
        "GraniteMoeHybridModel",
        "transformers.GraniteMoeHybridModel",
        "mindone.transformers.GraniteMoeHybridModel",
        (config,),
        {},
        (input_ids,),
        {
...
@pytest.mark.parametrize(
    ...
    [
        ...
        for case in GRANITEMOEHYBRID_CASES
