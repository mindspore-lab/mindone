...
"""Testing suite for the MindSpore Ministral model."""
...
model_tester = MinistralModelTester(parent=None)
(
    config,
    input_ids,
    token_type_ids,
...
MINISTRAL_CASES = [
    [
        ...
        "mindone.transformers.MinistralModel",
        (config,),
        {},
        (input_ids,),
        {
