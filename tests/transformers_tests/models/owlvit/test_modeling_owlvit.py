...
class OwlViTModelTester:
    def __init__(self, text_kwargs=None, vision_kwargs=None, is_training=True):
        ...
        self.text_model_tester = OwlViTTextModelTester(**text_kwargs)
        self.vision_model_tester = OwlViTVisionModelTester(**vision_kwargs)
        self.is_training = is_training
...
class OwlViTForObjectDetectionTester:
    def __init__(self, is_training=True):
        self.text_model_tester = OwlViTTextModelTester()
...
owlvit_model = OwlViTModelTester()
model_config, input_ids, attention_mask, pixel_values = owlvit_model.prepare_config_and_inputs()
detection_model = OwlViTForObjectDetectionTester()
