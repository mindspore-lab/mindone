...
model_tester = MptModelTester()
config, input_ids, input_mask, sequence_labels = model_tester.prepare_config_and_inputs()
MPT_CASES = [
    [
        "MptModel",
        "transformers.MptModel",
        "mindone.transformers.MptModel",
        (config,),
        {},
        (input_ids,),
        {
