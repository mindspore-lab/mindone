"""Adapted from https://github.com/huggingface/transformers/tree/main/tests//models/deberta_v2/test_modeling_deberta_v2.py."""
...
model_tester = DebertaV2ModelTester()
(
    config,
    input_ids,
    token_type_ids,
...
DeBERTa_v2_CASES = [
    [
        ...
        "mindone.transformers.DebertaV2ForMaskedLM",
        (config,),
        {},
        (input_ids,),
        {
    ...
    [
        ...
        "mindone.transformers.DebertaV2ForMultipleChoice",
        (config,),
        {},
    ...
    [
        ...
        "mindone.transformers.DebertaV2ForQuestionAnswering",
        (config,),
        {},
        (input_ids,),
        {
    ...
    [
        ...
        "mindone.transformers.DebertaV2ForSequenceClassification",
    ...
    [
        ...
        "mindone.transformers.DebertaV2ForTokenClassification",
        (config_has_num_labels,),
        {},
        (input_ids,),
        {
    ...
    [
        ...
        "mindone.transformers.DebertaV2Model",
        (config,),
        {},
        (input_ids,),
        {
