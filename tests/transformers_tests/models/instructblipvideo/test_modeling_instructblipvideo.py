...
import pytest
import torch
from transformers import InstructBlipVideoVisionConfig
...
model_tester = InstructBlipVideoVisionModelTester()
(
    config, pixel_values
...
BERT_CASES = [
    [
        ...
        "transformers.InstructBlipVideoVisionModel",
        "mindone.transformers.InstructBlipVideoVisionModel",
        (config,),
        {},
        (pixel_values,),
        {},
