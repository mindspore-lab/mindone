...
"""Testing suite for the MindSpore DINOv3ConvNext model."""
...
model_tester = DINOv3ConvNextModelTester()
...
_CASES = [
    [
        ...
        "mindone.transformers.DINOv3ConvNextModel",
        (config,),
        {},
        (pixel_values,),
        {},
