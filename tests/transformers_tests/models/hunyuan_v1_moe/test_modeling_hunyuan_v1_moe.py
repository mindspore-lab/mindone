...
"""Testing suite for the MindSpore HunYuanMoEV1 model."""
...
if transformers.__version__ >= "4.57.0":
    ...
    HUNYUANV1MOE_CASES = [
        [
            ...
            "transformers.HunYuanMoEV1ForCausalLM",
            "mindone.transformers.HunYuanMoEV1ForCausalLM",
            (config,),
            {},
            (),
            {
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            for case in HUNYUANV1MOE_CASES
