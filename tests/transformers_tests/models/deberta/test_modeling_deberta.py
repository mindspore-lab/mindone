"""Adapted from https://github.com/huggingface/transformers/tree/main/tests//models/deberta/test_modeling_deberta.py."""
...
model_tester = DebertaModelTester()
(
    config,
    input_ids,
    token_type_ids,
...
DeBERTa_CASES = [
    [
        ...
        "mindone.transformers.DebertaForMaskedLM",
        (config,),
        {},
        (input_ids,),
        {
    ...
    [
        ...
        "mindone.transformers.DebertaForQuestionAnswering",
        (config,),
        {},
        (input_ids,),
        {
    ...
    [
        ...
        "mindone.transformers.DebertaForSequenceClassification",
    ...
    [
        ...
        "mindone.transformers.DebertaForTokenClassification",
        (config_has_num_labels,),
        {},
        (input_ids,),
        {
    ...
    [
        ...
        "mindone.transformers.DebertaModel",
        (config,),
        {},
        (input_ids,),
        {
