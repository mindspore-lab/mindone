"""Adapted from https://github.com/huggingface/transformers/tree/main/tests/models/unispeech/test_modeling_unispeech.py."""
...
DTYPE_AND_THRESHOLDS = {"fp32": 5e-4, "fp16": 5e-3, "bf16": 3e-2}
MODES = [1]
...
model_tester = UniSpeechModelTester()
...
UNISPEECH_CASES = [
    [
        ...
        "mindone.transformers.UniSpeechModel",
        (config,),
        {},
    ...
    [
        ...
        "mindone.transformers.UniSpeechForPreTraining",
        (config,),
        {},
        (input_values, attention_mask),
        {},
    ...
    [
        ...
        "mindone.transformers.UniSpeechForCTC",
        (config,),
        {},
        (input_values, attention_mask),
        {},
    ...
    [
        ...
        "mindone.transformers.UniSpeechForSequenceClassification",
        (config,),
        {},
        (input_values, attention_mask),
        {},
