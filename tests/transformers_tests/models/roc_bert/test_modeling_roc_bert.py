...
class RoCBertModelTester:
    ...
    def prepare_config_and_inputs(self):
        ...
        input_shape_ids = ids_numpy([self.batch_size, self.seq_length], self.shape_vocab_size)
        input_pronunciation_ids = ids_numpy([self.batch_size, self.seq_length], self.pronunciation_vocab_size)
...
model_tester = RoCBertModelTester()
(
    config,
    inputs_dict,
...
ROCBERT_CASES = [
    [
        ...
        "mindone.transformers.RoCBertModel",
        (config,),
        {},
        (),
        {
            "input_ids": inputs_dict["input_ids"],
            "input_shape_ids": inputs_dict["input_shape_ids"],
            "input_pronunciation_ids": inputs_dict["input_pronunciation_ids"],
