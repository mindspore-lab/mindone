...
from mindone.transformers.models.gemma3.modeling_gemma3 import Gemma3TextModel, Gemma3ForCausalLM
...
model_tester = Gemma3ModelTester()
(
    config,
    input_ids,
    token_type_ids,
...
GEMMA3_CASES = [
    [
        ...
        "mindone.transformers.Gemma3TextModel",
        (config,),
        {},
        (),
        {
