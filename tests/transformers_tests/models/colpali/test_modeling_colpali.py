"""Adapted from https://github.com/huggingface/transformers/tree/main/tests//models/colpali/test_modeling_colpali.py."""
...
class ColPaliForRetrievalModelTester:
    ...
    def prepare_config_and_inputs_for_common(self):
        ...
        input_ids = ids_numpy([self.batch_size, self.seq_length], config.vlm_config.text_config.vocab_size - 1) + 1
...
model_tester = ColPaliForRetrievalModelTester()
...
COLPALI_CASES = [
    [
        ...
        "mindone.transformers.ColPaliForRetrieval",
        (config,),
        {},
        (),
        inputs_dict,
