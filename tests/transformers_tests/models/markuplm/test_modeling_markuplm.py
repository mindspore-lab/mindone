...
model_tester = MarkupLMModelTester()
...
MARKUPLM_CASES = [
    [
        ...
        "mindone.transformers.MarkupLMModel",
        (config,),
        {},
        (),
        {
            "input_ids": inputs_dict["input_ids"],
            "xpath_tags_seq": inputs_dict["xpath_tags_seq"],
            "xpath_subs_seq": inputs_dict["xpath_subs_seq"],
