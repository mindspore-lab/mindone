"""Adapted from https://github.com/huggingface/transformers/tree/main/tests//models/data2vec/test_modeling_data2vec_audio.py."""
...
class Data2VecAudioModelTester:
    ...
    def prepare_config_and_inputs_for_training(self, config, input_values, attention_mask):
        ...
        inputs_dict = {"input_values": input_values, "attention_mask": attention_mask, "labels": labels}
        return inputs_dict

    def prepare_config_and_inputs_for_common(self):
        config, input_values, attention_mask = self.prepare_config_and_inputs()
        inputs_dict = {"input_values": input_values, "attention_mask": attention_mask}
        inputs_dict_training = self.prepare_config_and_inputs_for_training(config, input_values, attention_mask)
        return config, inputs_dict, inputs_dict_training


model_tester = Data2VecAudioModelTester()
config, inputs_dict, inputs_dict_training = model_tester.prepare_config_and_inputs_for_common()

_CASES = [
    [
        "Data2VecAudioModel",
        "transformers.Data2VecAudioModel",
        "mindone.transformers.Data2VecAudioModel",
        (config,),
        {},
        (),
        inputs_dict,
    ...
    [
        ...
        "mindone.transformers.Data2VecAudioForCTC",
        (config,),
        {},
        (),
    ...
    [
        ...
        "mindone.transformers.Data2VecAudioForSequenceClassification",
        (config,),
        {},
        (),
        inputs_dict_training,
    ...
    [
        ...
        "mindone.transformers.Data2VecAudioForXVector",
        (config,),
        {},
        (),
        {
