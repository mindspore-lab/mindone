"""Adapted from https://github.com/huggingface/transformers/tree/main/tests/models/deepseek_vl_hybrid/test_modeling_deepseek_vl_hybrid.py."""
...
class DeepseekVLHybridModelTester:
    ...
    def prepare_config_and_inputs(self):
        ...
        high_res_pixel_values = floats_numpy(
            [
                self.batch_size,
                self.num_channels,
...
DeepseekVLHybrid_CASES = [
    [
        "DeepseekVLHybridModel",
        "transformers.DeepseekVLHybridModel",
        "mindone.transformers.DeepseekVLHybridModel",
        (config,),
        {},
        (),
        {
    ...
    [
        ...
        "transformers.DeepseekVLHybridForConditionalGeneration",
        "mindone.transformers.DeepseekVLHybridForConditionalGeneration",
        (config,),
        {},
        (),
        {
...
@pytest.mark.parametrize(
    ...
    [
        ...
        for case in DeepseekVLHybrid_CASES
