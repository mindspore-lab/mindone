"""Adapted from https://github.com/huggingface/transformers/tree/main/tests//models/qwen2_5_vl/test_modeling_qwen2_5_vl.py."""
...
model_tester = Qwen2_5_VLVisionText2TextModelTester()
