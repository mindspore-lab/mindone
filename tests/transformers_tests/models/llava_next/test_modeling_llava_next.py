"""Adapted from https://github.com/huggingface/transformers/tree/main/tests/models/llava_next/test_modeling_llava_next.py."""
import numpy as np
import pytest
import torch
...
model_tester = LlavaNextVisionText2TextModelTester()
...
_CASES = [
    [
        ...
        "mindone.transformers.LlavaNextForConditionalGeneration",
        (config,),
        {},
        (),
        inputs_dict,
