...
class LayoutLMModelTester:
    ...
    def prepare_config_and_inputs(self):
        ...
        bbox = ids_numpy([self.batch_size, self.seq_length, 4], self.range_bbox)
...
model_tester = LayoutLMModelTester()
(
    config,
    inputs_dict,
...
LAYOUTLM_CASES = [
    [
        ...
        "mindone.transformers.LayoutLMModel",
        (config,),
        {},
        (),
        {
