...
class Wav2Vec2BertModelTester:
    ...
    def prepare_config_and_inputs(self):
        ...
        input_features = floats_numpy(input_shape, self.vocab_size)
...
TEST_CASES = [
    [
        ...
        "mindone.transformers.Wav2Vec2BertModel",
        (config,),
        {},
        (),
        {
    ...
    [
        "Wav2Vec2BertForCTC",
        "transformers.Wav2Vec2BertForCTC",
        "mindone.transformers.Wav2Vec2BertForCTC",
        (config,),
        {},
        (),
        {
    ...
    [
        ...
        "transformers.Wav2Vec2BertForSequenceClassification",
        "mindone.transformers.Wav2Vec2BertForSequenceClassification",
        (classifier_config,),
        {},
        (),
        {
            "input_features": classifier_input_values,
    ...
    [
        ...
        "transformers.Wav2Vec2BertForXVector",
        "mindone.transformers.Wav2Vec2BertForXVector",
        (xvector_config,),
        {},
        (),
        {
            "input_features": xvector_input_values,
