...
class Kosmos2_5VisionModelTester:
    ...
    def prepare_config_and_inputs(self):
        flattened_patches = floats_numpy([self.batch_size, self.seq_length, self.patch_embed_hidden_size + 2])
...
class Kosmos2_5ModelTester:
    def __init__(
        ...
        self.text_model_tester = Kosmos2_5TextModelTester(**text_kwargs)
        self.vision_model_tester = Kosmos2_5VisionModelTester(**vision_kwargs)
...
model_tester = Kosmos2_5ModelTester()
config, inputs_dict = model_tester.prepare_config_and_inputs_for_common()

BERT_CASES = [
    [
        "Kosmos2_5ForConditionalGeneration",
        "transformers.Kosmos2_5ForConditionalGeneration",
        "mindone.transformers.Kosmos2_5ForConditionalGeneration",
        (config,),
        {},
        (),
        {**inputs_dict},
