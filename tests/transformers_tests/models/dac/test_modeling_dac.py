"""Adapted from https://github.com/huggingface/transformers/tree/main/tests/models/dac/test_modeling_dac.py."""
...
# Since the outputs are derived from the tensor.max, the threshold is relatively large.
