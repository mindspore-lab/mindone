...
class SiglipModelTester:
    def __init__(self, text_kwargs=None, vision_kwargs=None, is_training=True):
        ...
        if vision_kwargs is None:
            vision_kwargs = {}
        self.text_model_tester = SiglipTextModelTester(**text_kwargs)
        self.vision_model_tester = SiglipVisionModelTester(**vision_kwargs)
...
SIGLIP_CASES = [
    [
        ...
        "mindone.transformers.SiglipModel",
        (config,),
        {},
        (),
        {
