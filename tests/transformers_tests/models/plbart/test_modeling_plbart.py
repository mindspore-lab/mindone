...
"""Testing suite for the Mindspore PLBART model."""
...
model_tester = PLBartModelTester()
(
    config,
    inputs_dict,
...
PLBART_CASES = [
    [
        ...
        "mindone.transformers.PLBartModel",
        (config,),
        {},
        (),
        {
