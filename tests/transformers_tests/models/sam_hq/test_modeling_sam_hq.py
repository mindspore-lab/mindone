...
#
# This code is adapted from https://github.com/huggingface/transformers/blob/main/tests/models/sam_hq/test_modeling_sam_hq.py
#
...
"""Testing suite for the MindSpore SAM-HQ model."""
...
TEST_CASES = [
    [
        ...
        "mindone.transformers.SamHQVisionModel",
        (vision_config,),
        {},
        (),
        vision_inputs_dict,
    ...
    [
        ...
        "mindone.transformers.SamHQModel",
        (config,),
        {},
        (),
        inputs_dict,
