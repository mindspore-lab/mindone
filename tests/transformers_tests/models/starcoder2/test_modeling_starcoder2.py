...
BERT_CASES = [
    [
        ...
        "mindone.transformers.Starcoder2ForCausalLM",
        (config,),
        {},
        (input_ids,),
        {
    ...
    [
        ...
        "transformers.Starcoder2ForSequenceClassification",
        "mindone.transformers.Starcoder2ForSequenceClassification",
        (config,),
        {},
        (input_ids,),
        {
    ...
    [
        ...
        "transformers.Starcoder2ForTokenClassification",
        "mindone.transformers.Starcoder2ForTokenClassification",
        (config,),
        {},
        (input_ids,),
        {
    ...
    [
        ...
        "mindone.transformers.Starcoder2Model",
        (config,),
        {},
        (input_ids,),
        {
