"""Adapted from https://github.com/huggingface/transformers/tree/main/tests//models/rembert/test_modeling_rembert.py."""
...
model_tester = RemBertModelTester()
(
    config,
    input_ids,
    token_type_ids,
...
RemBert_CASES = [
    [
        ...
        "mindone.transformers.RemBertForMaskedLM",
        (config,),
        {},
        (input_ids,),
        {
    ...
    [
        ...
        "mindone.transformers.RemBertForMultipleChoice",
        (config,),
        {},
    ...
    [
        ...
        "mindone.transformers.RemBertForQuestionAnswering",
        (config,),
        {},
        (input_ids,),
        {
    ...
    [
        ...
        "mindone.transformers.RemBertForSequenceClassification",
    ...
    [
        ...
        "mindone.transformers.RemBertForTokenClassification",
        (config_has_num_labels,),
        {},
        (input_ids,),
        {
    ...
    [
        ...
        "mindone.transformers.RemBertModel",
        (config,),
        {},
        (input_ids,),
        {
