...
LLAMA_CASES = [
    [
        ...
        "mindone.transformers.ElectraForCausalLM",
        (config,),
        {},
        (input_ids,),
    ...
    [
        ...
        "mindone.transformers.ElectraForMaskedLM",
        (config,),
        {},
        (input_ids,),
        {"attention_mask": input_mask, "token_type_ids": token_type_ids, "labels": token_labels},
    ...
    [
        ...
        "mindone.transformers.ElectraForMultipleChoice",
        (config,),
        {},
    ...
    [
        ...
        "mindone.transformers.ElectraForQuestionAnswering",
        (config,),
        {},
        (input_ids,),
        {
    ...
    [
        ...
        "mindone.transformers.ElectraForSequenceClassification",
        (config,),
        {},
        (input_ids,),
        {
    ...
    [
        ...
        "mindone.transformers.ElectraModel",
        (config,),
        {},
        (input_ids,),
    ...
    [
        ...
        "mindone.transformers.ElectraForTokenClassification",
        (config,),
        {},
        (input_ids,),
        {"attention_mask": input_mask, "token_type_ids": token_type_ids, "labels": token_labels},
