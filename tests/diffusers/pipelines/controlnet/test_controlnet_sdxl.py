...
@ddt
class StableDiffusionXLControlNetPipelineFastTests(PipelineTesterMixin, unittest.TestCase):
    pipeline_config = [
        [
            "controlnet",
    ...
    def test_inference(self, mode, dtype):
        ...
        pt_pipe_cls = get_module("diffusers.pipelines.controlnet.StableDiffusionXLControlNetPipeline")
        ms_pipe_cls = get_module("mindone.diffusers.pipelines.controlnet.StableDiffusionXLControlNetPipeline")
...
@slow
@ddt
class ControlNetSDXLPipelineSlowTests(PipelineTesterMixin, unittest.TestCase):
    @data(*test_cases)
    @unpack
    def test_canny(self, mode, dtype):
        ...
        pipe_cls = get_module("mindone.diffusers.pipelines.controlnet.StableDiffusionXLControlNetPipeline")
    ...
    def test_depth(self, mode, dtype):
        ...
        controlnet_cls = get_module("mindone.diffusers.models.controlnet.ControlNetModel")
        controlnet = controlnet_cls.from_pretrained("diffusers/controlnet-depth-sdxl-1.0", mindspore_dtype=ms_dtype)
