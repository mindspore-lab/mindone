...
@ddt
class LatentConsistencyModelImg2ImgPipelineFastTests(PipelineTesterMixin, unittest.TestCase):
    pipeline_config = [
        [
            "unet",
    ...
    def test_lcm_multistep(self, mode, dtype):
        ...
        pt_pipe_cls = get_module("diffusers.pipelines.latent_consistency_models.LatentConsistencyModelImg2ImgPipeline")
