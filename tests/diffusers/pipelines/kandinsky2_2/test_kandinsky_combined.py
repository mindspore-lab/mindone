...
@slow
@ddt
class KandinskyV22PipelineCombinedIntegrationTests(PipelineTesterMixin, unittest.TestCase):
    @data(*test_cases)
    @unpack
    def test_kandinsky(self, mode, dtype):
        ...
        pipe_cls = get_module("mindone.diffusers.pipelines.kandinsky2_2.KandinskyV22CombinedPipeline")
        pipe = pipe_cls.from_pretrained("kandinsky-community/kandinsky-2-2-decoder", mindspore_dtype=ms_dtype)
    ...
    def test_kandinsky_img2img(self, mode, dtype):
        ...
        pipe_cls = get_module("mindone.diffusers.pipelines.kandinsky2_2.KandinskyV22Img2ImgCombinedPipeline")
        pipe = pipe_cls.from_pretrained("kandinsky-community/kandinsky-2-2-decoder", mindspore_dtype=ms_dtype)
    ...
    def test_kandinsky_inpaint(self, mode, dtype):
        ...
        pipe_cls = get_module("mindone.diffusers.pipelines.kandinsky2_2.KandinskyV22InpaintCombinedPipeline")
        pipe = pipe_cls.from_pretrained("kandinsky-community/kandinsky-2-2-decoder-inpaint", mindspore_dtype=ms_dtype)
