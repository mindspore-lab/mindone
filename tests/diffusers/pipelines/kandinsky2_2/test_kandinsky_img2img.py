...
class KandinskyV22Img2ImgPipelineFastTests(PipelineTesterMixin, unittest.TestCase):
    ...
    def test_kandinsky_img2img(self, mode, dtype):
        ...
        pt_pipe_cls = get_module("diffusers.pipelines.kandinsky2_2.KandinskyV22Img2ImgPipeline")
        ms_pipe_cls = get_module("mindone.diffusers.pipelines.kandinsky2_2.KandinskyV22Img2ImgPipeline")
