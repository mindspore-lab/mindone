...
@slow
@ddt
class KandinskyV22PipelineIntegrationTests(PipelineTesterMixin, unittest.TestCase):
    @data(*test_cases)
    @unpack
    def test_kandinsky_text2img(self, mode, dtype):
        ...
        pipeline_cls = get_module("mindone.diffusers.pipelines.kandinsky2_2.KandinskyV22Pipeline")
        pipeline = pipeline_cls.from_pretrained("kandinsky-community/kandinsky-2-2-decoder", mindspore_dtype=ms_dtype)
        ...
        expected_image = load_downloaded_numpy_from_hf_hub(
            ...
            f"kandinsky_text2img_{dtype}.npy",
