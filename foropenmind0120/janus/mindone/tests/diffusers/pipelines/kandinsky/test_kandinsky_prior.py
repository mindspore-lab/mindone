...
class KandinskyPriorPipelineFastTests(PipelineTesterMixin, unittest.TestCase):
    ...
    def test_kandinsky_prior(self, mode, dtype):
        ...
        pt_pipe_cls = get_module("diffusers.pipelines.kandinsky.KandinskyPriorPipeline")
        ms_pipe_cls = get_module("mindone.diffusers.pipelines.kandinsky.KandinskyPriorPipeline")
