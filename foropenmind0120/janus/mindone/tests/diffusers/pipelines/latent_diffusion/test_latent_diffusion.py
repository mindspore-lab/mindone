...
class LDMTextToImagePipelineFastTests(PipelineTesterMixin, unittest.TestCase):
    ...
    @data(*test_cases)
    @unpack
    def test_inference_text2img(self, mode, dtype):
        ms.set_context(mode=mode)

        pt_components, ms_components = self.get_dummy_components()
        pt_pipe_cls = get_module("diffusers.pipelines.latent_diffusion.LDMTextToImagePipeline")
        ms_pipe_cls = get_module("mindone.diffusers.pipelines.latent_diffusion.LDMTextToImagePipeline")
