...
class IFImg2ImgPipelineFastTests(PipelineTesterMixin, IFPipelineTesterMixin, unittest.TestCase):
    ...
    def test_inference(self, mode, dtype):
        ...
        pt_pipe_cls = get_module("diffusers.pipelines.deepfloyd_if.IFImg2ImgPipeline")
        ms_pipe_cls = get_module("mindone.diffusers.pipelines.deepfloyd_if.IFImg2ImgPipeline")
