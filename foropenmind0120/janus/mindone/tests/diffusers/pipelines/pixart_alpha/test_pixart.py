...
class PixArtAlphaPipelineFastTests(PipelineTesterMixin, unittest.TestCase):
    ...
    def test_inference(self, mode, dtype):
        ...
        pt_pipe_cls = get_module("diffusers.pipelines.pixart_alpha.PixArtAlphaPipeline")
        ms_pipe_cls = get_module("mindone.diffusers.pipelines.pixart_alpha.PixArtAlphaPipeline")
...
@slow
@ddt
class PixArtAlphaPipelineIntegrationTests(PipelineTesterMixin, unittest.TestCase):
    ...
    def test_pixart_1024(self, mode, dtype):
        ...
        pipe_cls = get_module("mindone.diffusers.pipelines.pixart_alpha.PixArtAlphaPipeline")
