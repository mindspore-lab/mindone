...
By default the [`SD3ControlNetModel`](controlnet_sd3.md#mindone.diffusers.SD3ControlNetModel) should be loaded with [`ModelMixin.from_pretrained`](overview.md#mindone.diffusers.ModelMixin.from_pretrained).
