...
!!! tip
    ...
    Want to generate images of something else? Take a look at the training [guide](../training/unconditional_training.md) to learn how to train a model to generate your own images.
