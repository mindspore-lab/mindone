...
By default the [`FluxControlNetModel`](controlnet_flux.md#mindone.diffusers.FluxControlNetModel) should be loaded with [`ModelMixin.from_pretrained`](overview.md#mindone.diffusers.ModelMixin.from_pretrained).
...
::: mindone.diffusers.models.controlnet_flux.FluxControlNetOutput
