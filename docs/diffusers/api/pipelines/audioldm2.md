...
The following example demonstrates how to construct good music and speech generation using the aforementioned tips: [example](https://mindspore-lab.github.io/mindone/latest/diffusers/api/pipelines/audioldm2/#mindone.diffusers.pipelines.AudioLDM2Pipeline.__call__).
