...
While calling [`StableDiffusionPanoramaPipeline`](https://mindspore-lab.github.io/mindone/latest/diffusers/api/pipelines/panorama/#mindone.diffusers.StableDiffusionPanoramaPipeline), it's possible to specify the `view_batch_size` parameter to be > 1 to speedup the generation process and increase VRAM usage.
...
![img](https://github.com/user-attachments/assets/2c4c4f0f-5791-483a-8842-7abb9d178550)

But with circular padding, the right and the left parts are matching (`circular_padding=True`):
![img](https://github.com/user-attachments/assets/667b961d-6c4d-4e32-96f9-ba628140b77b)
