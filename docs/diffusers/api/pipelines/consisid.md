...
|:---:|:---:|
| [`BestWishYsh/ConsisID-preview`](https://huggingface.co/BestWishYsh/ConsisID-preview) | mindspore.bfloat16 |
| [`BestWishYsh/ConsisID-1.5`](https://huggingface.co/BestWishYsh/ConsisID-preview) | mindspore.bfloat16 |

### Memory optimization

ConsisID requires about 44 GB of device memory to decode 49 frames (6 seconds of video at 8 FPS) with output resolution 720x480 (W x H). The following memory optimizations could be used to reduce the memory footprint. For replication, you can refer to [this](https://gist.github.com/SHYuanBest/bc4207c36f454f9e969adbb50eaf8258) script.
