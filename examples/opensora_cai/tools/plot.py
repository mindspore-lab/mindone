...
if __name__ == "__main__":
    ...
    parser.add_argument("--smooth", action="store_true",  help="smooth curve by exponential weighted (ema). default: False")
    parser.add_argument("--alpha", default=0.01, type=float, help="smooth factor alpha, the smaller this value, the smoother the curve")
    parser.add_argument("--linewidth", default=1., type=float, help="curve line width")
