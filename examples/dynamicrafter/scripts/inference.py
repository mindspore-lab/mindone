...
from utils import load_data_prompts, save_results_seperate, get_latent_z
...
def parse_args():
    ...
    parser.add_argument("--jit_level", default="O0", choices=["O0", "O1", "O2"], type=str, help="model jit config level, refer to MindSpore doc")
