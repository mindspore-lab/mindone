...
sys.modules[HunyuanImage3Text2ImagePipeline.__module__].randn_tensor = randn_tensor
sys.modules[AutoencoderKLConv3D.__module__].randn_tensor = randn_tensor
...
class HunyuanImage3ForCausalMM(HunyuanImage3PreTrainedModel, GenerationMixin):
    ...
    def prepare_model_inputs(
        ...
        **kwargs,
        ...
        generator = [torch.Generator(device="cpu").manual_seed(seed) for seed in seeds]
