...
if __name__ == "__main__":
    ...
    parser.add_argument("--params_info_dir", type=str, default="params_info", help="model ckpt name, e.g. emu3-e50.ckpt")
    parser.add_argument("--group_size", type=int, default=8, help="group size")
    args = parser.parse_args()

    do_ckpt_combine_offline(args.checkpoints_dir, args.ckpt_name, args.params_info_dir, args.group_size)