...
Usage:
cd examples/emu3
python emu3/train/prepare_vqa_data.py --model-path DIR-TO-Emu3-VisionTokenizer --data-path DIR-TO-DATA.json --output-path DATA-DIR
"""
...
def main():
    ...
    # change encoding accordingly, e.g., utf-8
    with open(args.data_path, encoding="windows-1254") as f:
