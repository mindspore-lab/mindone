...
class FaceRestoreHelper(object):
    ...
    def __init__(self,
        ...
        self.face_det = init_detection_model(det_model, half=False, model_rootpath=model_rootpath)
        ...
        for idx, affine_matrix in enumerate(self.affine_matrices):
            ...
            if save_inverse_affine_path is not None:
                ...
                with open(save_path, "wb") as file:
                    pickle.dump(inverse_affine, file)
    ...
    def paste_faces_to_input_image(self, save_path=None, upsample_img=None):
        ...
        for restored_face, inverse_affine in zip(self.restored_faces, self.inverse_affine_matrices):
            ...
            if self.use_parse:
                ...
                face_input = ms.Tensor(normalize(face_input.asnumpy()))
                # normalize(face_input, (0.5, 0.5, 0.5), (0.5, 0.5, 0.5), inplace=True)
                face_input = ops.unsqueeze(face_input, 0)

                out = self.face_parse(face_input)[0]
                out = out.argmax(axis=1).squeeze().asnumpy()
