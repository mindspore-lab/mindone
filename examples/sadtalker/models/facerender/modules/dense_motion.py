...
class DenseMotionNetwork(nn.Cell):
    ...
    def __init__(
        ...
        self.mask = nn.Conv3d(
            self.hourglass.out_filters, num_kp + 1, kernel_size=7, pad_mode="pad", padding=3, has_bias=True
        )
    ...
    def create_sparse_motions(self, feature, kp_driving, kp_source):
        ...
        identity_grid = make_coordinate_grid((d, h, w), type=kp_source["value"].dtype)
    ...
    def create_heatmap_representations(self, feature, kp_driving, kp_source):
        ...
        # adding background feature
        zeros = ops.zeros((heatmap.shape[0], 1, spatial_size[0], spatial_size[1], spatial_size[2]), heatmap.dtype)
