...
class Conv2d(nn.Cell):
    def __init__(self, cin, cout, kernel_size, stride, padding, residual=False, *args, **kwargs):
        ...
        self.conv_block = nn.SequentialCell(
            nn.Conv2d(cin, cout, kernel_size, stride, pad_mode="pad", padding=padding, has_bias=True),
...
class AudioEncoder(nn.Cell):
    ...
    def construct(self, audio_sequences):
        ...
        audio_sequences = ops.cat([audio_sequences[:, i] for i in range(audio_sequences.shape[1])], axis=0)
