...
class SaverMixin:
    ...
    def convert_data(self, data):
        if data is None:
            ...
            raise TypeError(
                "Data must be in type numpy.ndarray, ms.Tensor, list or dict, getting",
                type(data),
            )
    ...
    def save_img_sequence(
        ...
        if save_format == "gif":
            ...
            # the above cv2 version gif does not loop play, use imageio below
            gif_dumper.vid2gif(save_path, imgs)
    ...
    def save_obj(
        ...
        map_Kd: Optional[Tensor] = None,
        map_Ks: Optional[Tensor] = None,
        map_Bump: Optional[Tensor] = None,
        map_Pm: Optional[Tensor] = None,
        map_Pr: Optional[Tensor] = None,
        map_format: str = "jpg",
    ) -> List[str]:
        save_paths: List[str] = []
