# TODO: migrate share.py
# from share import *
# share.py runs: disable_verbosity() enable_sliced_attention() from cldm.hack 
...
def process(input_image, prompt, a_prompt, n_prompt, num_samples, image_resolution, ddim_steps, guess_mode, strength, scale, seed, eta, low_threshold, high_threshold):
    ...
    control = ops.transpose(control, (0, 3, 1, 2)).clone()  # 'b h w c -> b c h w'
    # if seed == -1:
