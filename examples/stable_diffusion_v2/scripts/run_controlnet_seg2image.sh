...
nohup python image2image.py \
    ...
    --model_ckpt $DATA_DIR"control_sd15_segmentation_ms.ckpt" \
    ...
    --segmentation_ckpt_path $DATA_DIR"deeplabv3plus_s16_ascend_v190_voc2012_research_cv_s16acc79.06_s16multiscale79.96_s16multiscaleflip80.12.ckpt" \
    --task_name $TASK_NAME \
