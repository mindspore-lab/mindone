...
if __name__ == "__main__":
    ...
    parser.add_argument("--part_list",
                        required=False,
                        type=str,
                        help="A list of part IDs indicating complete data. "
                             "For example, input \"[1,2,3]\" for parts 1, 2, and 3.")
    parser.add_argument("--all_part",
                        default="False",
                        type=str,
                        help="Generate num_samples.json for all 64 parts (True/False)")
