...
> Resolution refers to the image resolution used in training and is also the optimal choice for image generation. Other vaules (divisable by 64) are worakable but may degrade the generation quality.
<!---
</details>
-->
