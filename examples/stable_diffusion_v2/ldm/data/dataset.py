...
def load_controlnet_data(
    ...
    # todo: not sure if need customize this part
    loader = build_dataloader_ft(dataset, datalen, controlnet_collate, batch_size, device_num, rank_id=rank_id)
