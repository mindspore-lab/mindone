...
class DPMSolverSampler(object):
    ...
    def sample(self,
        ...
        dpm_solver = DPM_Solver(model_fn, self.noise_schedule, algorithm_type=self.algorithm_type, correcting_xt_fn=correcting_xt_fn)
        
        x, intermediates = dpm_solver.sample(img, steps=S, t_start=t_start, t_end=t_end, skip_type=skip_type, method=method, order=order, lower_order_final=lower_order_final, return_intermediate=True)
