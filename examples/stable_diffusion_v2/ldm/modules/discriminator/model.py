...
class LPIPSWithDiscriminator(nn.Cell):
    def __init__(
        ...
        self.perceptual_loss = LPIPS().to_float(self.dtype)
    ...
    def construct(
        ...
        logvar,
        global_step, 
        d_weight=1., cond=None, weights=None, G=False
    ):
        ...
        if not G:
            ...
            return d_loss, d_loss, d_loss, d_loss, d_loss, d_loss
        ...
        return loss, recons, p_loss, self.kl_weight * kl_loss, nll_loss, g_loss, g_loss
