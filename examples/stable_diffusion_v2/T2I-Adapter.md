...
| SD Compatibility | Task         | SD Train Version | Dataset                                | Context         | Train Time      | Throughput   | Recipe                                      | Weights                                                                                                          |
|:----------------:|--------------|:----------------:|----------------------------------------|-----------------|-----------------|--------------|---------------------------------------------|------------------------------------------------------------------------------------------------------------------|
|       2.x        | Segmentation |       2.1        | [COCO-Stuff](#segmentation-coco-stuff) | D910Bx4-MS2.1-G | 10h 35m / epoch | 39.2 img / s | [yaml](configs/t2i-adapter/v2.1_train.yaml) | [Download](https://download.mindspore.cn/toolkits/mindone/t2i-adapters/t2iadapter_seg_sd21-86d4e0db.ckpt)        |
|                  |              |                  |                                        |                 |                 |              |                                             |                                                                                                                  |
