...
<p align="center">
  <em> Figure 1. TODO: add LoRA method figure[<a href="#references">1</a>] </em>
</p>
...
- Rank-decomposition matrices have significantly fewer parameters than original model.
...
**MindONE** supports LoRA finetuning for Stable Diffusion models based on MindSpore and Ascend platform.
...
Here are some example results for LoRA finetuning.
