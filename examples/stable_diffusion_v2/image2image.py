...
if __name__ == "__main__":
    ...
    parser.add_argument("--task_name", type=str, default="canny2image", help="task name as folder name, used to save results")
    ...
    parser.add_argument("--sampling_steps", type=int, default=50, choices=range(1,101), help="number of ddim sampling steps")
    ...
    parser.add_argument("--mode", type=str, default="canny", choices=[MODE['canny']], help="control net task mode, only support canny now")
    # args for canny
    parser.add_argument("--low_threshold", type=int, default=100, choices=range(1,256), help="low threshold for canny")
    parser.add_argument("--high_threshold", type=int, default=200, choices=range(1,256), help="high threshold for canny")
