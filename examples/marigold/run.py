...
if __name__ == "__main__":
    ...
    if args.ms_ckpt:
        if checkpoint_path[-5:] != ".ckpt":
            logging.warning("You are using a mindspore checkpoint, it should be a ckpt file.")
    ...
    logging.info(f"Inference device = {args.device}, with mode = {context.get_context('mode')}")
