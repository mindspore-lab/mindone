...
output_dir=outputs/stdit2_1024x576x$num_frames

msrun --bind_core=True --master_port=8200 --worker_num=8 --local_worker_num=8 --log_dir=$output_dir  \
	python scripts/train.py \
	--config configs/opensora-v1-1/train/stdit2_1024.yaml \
    ...
    --vae_latent_folder datasets/sora_overfitting_dataset_0410_vae/latent_1024x576 \
    --image_size 1024 576 \
