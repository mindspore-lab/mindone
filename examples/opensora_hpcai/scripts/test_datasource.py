...
def initialize_dataset(
    ...
    return dataloader, num_src_samples, datasets[0]
...
def main(args):
    ...
    # 3. create dataset
    dataloader, num_src_samples, src_dataset = initialize_dataset(
        args,
        args.csv_path,
        args.video_folder,
    ...
    if not args.custom_train:
        ...
        print(f"D--: start_epoch {start_epoch}, num_epochs {num_epochs}")
        for epoch in range(start_epoch + 1, num_epochs + 1):
            ...
            samples_per_epoch = num_src_samples
            
            for step in range(samples_per_epoch):
                data = src_dataset.__getitem__(step)[0]
