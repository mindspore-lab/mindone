...
class AutoencoderKLCausal3D(ModelMixin, ConfigMixin, FromOriginalVAEMixin):
    ...
    def __init__(self, config: AutoEncoder3DConfig):
        ...
        self.quant_conv = mint.nn.Conv3d(2 * config.latent_channels, 2 * config.latent_channels, kernel_size=1)
        self.post_quant_conv = mint.nn.Conv3d(config.latent_channels, config.latent_channels, kernel_size=1)
