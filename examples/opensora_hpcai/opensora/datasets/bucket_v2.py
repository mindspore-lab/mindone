...
from .aspect_v2 import get_closest_ratio, get_resolution_with_aspect_ratio
...
class Bucket:
    def __init__(self, bucket_config: dict[str, dict[int, Union[tuple[float, int], tuple[tuple[float, float], int]]]]):
        """
        Args:
        ...
        _logger.info(f"Number of buckets: {num_bucket}")
