...
# todo: We replace torch.FloatTensor to ms.Tensor, which is only used for type hinting. We believe it's ok.
...
class BaseModelOutput(ModelOutput):
    ...
    last_hidden_state: ms.Tensor = None  # todo: dtype=ms.float32
