...
def load_tf_weights_in_t5(model, config, tf_checkpoint_path):
    ...
    for txt_name in names:
        ...
        pointer.data = ms.Tensor(array.astype(np.float32))
        tf_weights.pop(txt_name, None)
...
class T5Stack(T5PreTrainedModel):
    ...
    def construct(
        ...
        for i, (layer_module, past_key_value) in enumerate(zip(self.block, past_key_values)):
            ...
            if self.gradient_checkpointing and self.training:
                raise NotImplementedError("gradient_checkpointing is not available!")
...
class T5Model(T5PreTrainedModel):
    ...
    def construct(
        ...
        decoder_input_ids: Optional[ms.Tensor] = None,  # torch.LongTensor
        decoder_attention_mask: Optional[ms.Tensor] = None,  # torch.BoolTensor
...
class T5ForConditionalGeneration(T5PreTrainedModel):
    ...
    def construct(
        ...
        inputs_embeds: Optional[ms.Tensor] = None,
        decoder_inputs_embeds: Optional[ms.Tensor] = None,
        labels: Optional[ms.Tensor] = None,  # torch.LongTensor
        use_cache: Optional[bool] = None,
        output_attentions: Optional[bool] = None,
        output_hidden_states: Optional[bool] = None,
        return_dict: Optional[bool] = None,
...
class T5ForQuestionAnswering(T5PreTrainedModel):
    ...
    def construct(
        ...
        cross_attn_head_mask: Optional[ms.Tensor] = None,
        encoder_outputs: Optional[Tuple[Tuple[ms.Tensor]]] = None,
        start_positions: Optional[ms.Tensor] = None,  # torch.LongTensor
        end_positions: Optional[ms.Tensor] = None,  # torch.LongTensor
        inputs_embeds: Optional[ms.Tensor] = None,
        decoder_inputs_embeds: Optional[ms.Tensor] = None,
        use_cache: Optional[bool] = None,
        output_attentions: Optional[bool] = None,
