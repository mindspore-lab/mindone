...
#         x_flat = x.flatten(start_dim=1)
#         residual = residual.flatten(start_dim=1)
#         x_plus_residual = ops.index_add(x_flat, axis=0, indices=brange, y=residual.to(dtype=x.dtype)*residual_scale_factor)
#     else:
#         # TODO: ref: https://github.com/facebookresearch/xformers/blob/main/xformers/ops/indexing.py#L104 =? a Autograd function
...
# TODO: used xformers.ops.fmha.BlockDiagonalMask.from_seqlens, need workaround
...
#         if self.training and self.sample_drop_ratio > 0.0: #TODO: training pipeline
...
#     def construct(self, x_or_x_list, cam_emb_or_cam_emb_list):
#         if isinstance(x_or_x_list, Tensor) and isinstance(cam_emb_or_cam_emb_list, Tensor) :
#             return super().construct(x_or_x_list, cam_emb_or_cam_emb_list)
