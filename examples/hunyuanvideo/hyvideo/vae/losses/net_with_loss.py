...
class GeneratorWithLoss(nn.Cell):
    def __init__(
        ...
        discriminator: nn.Cell = None,
        dtype: str = "fp32",
        lpips_ckpt_path: str = None,
        ...
        self.logvar = ms.Parameter(ms.Tensor([logvar_init], dtype=self.dtype), requires_grad=learn_logvar)
    ...
    def construct(self, x: ms.Tensor, global_step: ms.Tensor = -1, weights: ms.Tensor = None, cond=None):
        ...
        outputs = self.autoencoder(x, sample_posterior=True)
