...
from hyvideo.modules.attention import VanillaAttention, FlashAttention
...
def test_attn_varlen(pt_np=None):
    ...
    q, k, v, cu_seqlens_q, cu_seqlens_kv, max_seqlen = attn_in['q'], attn_in['k'], attn_in['v'], attn_in['cu_seqlens_q'], attn_in['cu_seqlens_kv'], attn_in['max_seqlen']
    ...
    flash_attention = FlashAttentionScore(heads_num, keep_prob=1., scale_value=1/math.sqrt(head_dim), input_layout="TND")
