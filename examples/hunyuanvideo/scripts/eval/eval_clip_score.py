...
import clip
from hyvideo.utils.dataset_utils import create_dataloader
...
class DummyDataset:
    ...
    def __init__(
        ...
        super().__init__()
        assert (
            real_flag in self.FLAGS and generated_flag in self.FLAGS
...
def main():
    ...
    parser.add_argument(
        "--generated_flag", type=str, default="txt", help=("The modality of generated path. " "Default to txt")
    )
    parser.add_argument("--real_path", type=str, help=("Paths to the real images or " "to .npz statistic files"))
    parser.add_argument(
        "--generated_path", type=str, help=("Paths to the generated images or " "to .npz statistic files")
    )
    ...
    clip_score = calculate_clip_score(dataloader, model, args.real_flag, args.generated_flag)
