...
class AudioDiffusion(nn.Cell):
    ...
    def construct(self, latents, input_ids, attention_mask, validation_mode=False):
        ...
        model_pred = self.unet(noisy_latents, t, encoder_hidden_states, encoder_attention_mask=boolean_encoder_mask)
    ...
    def inference(
        ...
        uncond_batch = self.tokenizer([""] * len(prompt), self.tokenizer.max_length, padding, truncation)
