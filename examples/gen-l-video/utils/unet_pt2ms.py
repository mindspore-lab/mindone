...
if __name__ == "__main__":
    ...
    pytorch_model_paths = [
        "models/diffusion_pytorch_model.bin",
    ]
    ...
    # build the model
    unet3d = instantiate_from_config("configs/unet3d.yaml")

    # convert the weights from PyTorch to MindSpore
    load_pt_weights_in_model(unet3d, pytorch_model_paths[0])
