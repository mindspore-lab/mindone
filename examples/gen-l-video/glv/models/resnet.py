...
class ResnetBlock3D(nn.Cell):
    def __init__(
        ...
        *,
        ...
        self.conv1 = InflatedConv3d(in_channels, out_channels, 3, stride=1, pad_mode="pad", padding=1, has_bias=True)
        ...
        self.conv2 = InflatedConv3d(out_channels, out_channels, 3, stride=1, pad_mode="pad", padding=1, has_bias=True)
        ...
        if self.use_in_shortcut:
            self.conv_shortcut = InflatedConv3d(
                in_channels, out_channels, 1, stride=1, pad_mode="valid", padding=0, has_bias=True
            )
...
class Upsample3D(nn.Cell):
    def __init__(self, channels, use_conv=False, use_conv_transpose=False, out_channels=None, name="conv"):
        ...
        if use_conv_transpose:
            ...
            conv = InflatedConv3d(self.channels, self.out_channels, 3, pad_mode="pad", padding=1, has_bias=True)
    ...
    def construct(self, hidden_states, output_size=None):
        ...
        if output_size is None:
            hidden_states = ops.interpolate(hidden_states, scale_factor=[1.0, 2.0, 2.0], mode="nearest")
        else:
