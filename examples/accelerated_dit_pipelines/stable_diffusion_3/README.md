...
You can download model weights through [HuggingFace](https://huggingface.co/stabilityai/stable-diffusion-3-medium-diffusers).

```
huggingface-cli download stabilityai/stable-diffusion-3-medium-diffusers --local-dir ckpt/stable-diffusion-3-medium-diffusers
```
