...
def parse_args():
    ...
    parser.add_argument("--train_data_type", default="video_file", type=str, help="type of data for training")
    ...
    parser.add_argument("--save_data_type", default="float32", type=str, help="data type when saving embedding cache")
