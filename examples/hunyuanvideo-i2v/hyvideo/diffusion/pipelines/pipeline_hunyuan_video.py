...
#
# This code is adapted from https://github.com/Tencent-Hunyuan/HunyuanVideo-I2V to work with MindSpore.
#
...
class HunyuanVideoPipeline(DiffusionPipeline):
    ...
    def encode_prompt(
        ...
        Args:
            ...
            semantic_images (`List[ms.Tensor]`, *optional*):
        """
        ...
        if do_classifier_free_guidance and negative_prompt_embeds is None:
            ...
            if semantic_images is not None:
                uncond_image = [black_image(img.shape[0], img.shape[1]) for img in semantic_images]
            else:
                uncond_image = None
    ...
    def prepare_latents(
        ...
        if i2v_mode and i2v_stability:
            ...
            x0 = randn_tensor(shape, generator=generator, dtype=dtype)
            x1 = img_latents
    ...
    def __call__(
        ...
        img_latents: Optional[ms.Tensor] = None,
        semantic_images=None,
        **kwargs,
    ):
        r"""
        ...
        if i2v_mode and i2v_condition_type == "latent_concat":
            ...
            i2v_mask = mint.zeros(video_length)
            i2v_mask[0] = 1

            mask_concat = mint.ones(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                latent_model_input = (
                    mint.cat([latent_model_input] * 2) if self.do_classifier_free_guidance else latent_model_input
                )
