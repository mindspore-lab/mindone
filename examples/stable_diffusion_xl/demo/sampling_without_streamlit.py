...
def get_parser_sample():
    ...
    parser.add_argument("--control_path", type=str, help="path of control image (canny edge) for controlnet, if not None, --image_path is not in effect, use --control_path as control.")
