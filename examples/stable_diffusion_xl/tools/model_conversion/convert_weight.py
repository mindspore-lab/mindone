...
if __name__ == "__main__":
    ...
    parser.add_argument("--key_torch", type=str, default="./scripts/convert/torch_key.yaml")
    parser.add_argument("--key_ms", type=str, default="./scripts/convert/mindspore_key.yaml")
