...
# Adapted from https://github.com/facebookresearch/sam2/blob/main/sam2/modeling/memory_attention.py
...
class MemoryAttentionLayer(nn.Cell):
    def __init__(
        self,
        activation: str,
        cross_attention: nn.Cell,
        d_model: int,
        dim_feedforward: int,
        dropout: float,
...
class MemoryAttention(nn.Cell):
    ...
    def construct(
        self,
        curr: Tensor,  # self-attention inputs
        memory: Tensor,  # cross-attention inputs
