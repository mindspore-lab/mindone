...
# Adapted from https://github.com/facebookresearch/sam2/blob/main/sam2/modeling/sam/transformer.py
...
class RoPEAttention(Attention):
    ...
    def construct(self, q: Tensor, k: Tensor, v: Tensor, num_k_exclude_rope: int = 0) -> Tensor:
        ...
        q_rotated, k_rotated = apply_rotary_enc(
            q,
            k[:, :, :num_k_rope],
        ...
        q = q_rotated
        k = mint.cat((k_rotated, k[:, :, num_k_rope:]), dim=-2)
