...
# Adapted from https://github.com/facebookresearch/sam2/blob/main/sam2/utils/amg.py
...
def mask_to_rle_pytorch(tensor: ms.Tensor) -> List[Dict[str, Any]]:
    """
...
def calculate_stability_score(masks: ms.Tensor, mask_threshold: float, threshold_offset: float) -> ms.Tensor:
    """
...
def uncrop_masks(masks: ms.Tensor, crop_box: List[int], orig_h: int, orig_w: int) -> ms.Tensor:
    ...
    return mint.nn.functional.pad(masks, pad, value=0)
