...
# Adapted from https://github.com/facebookresearch/sam2/blob/main/sam2/build_sam.py
    ...
    **kwargs,
    ...
    if apply_postprocessing:
        ...
        hydra_overrides_extra += [
            ...
            "++model.sam_mask_decoder_extra_args.dynamic_multimask_stability_delta=0.05",
            "++model.sam_mask_decoder_extra_args.dynamic_multimask_stability_thresh=0.98",
            # the sigmoid mask logits on interacted frames with clicks in the memory encoder so that the encoded masks are exactly \
            # as what users see from clicking
