...
from mindone.diffusers.loaders import SD3LoraLoaderMixin
...
from .infer.normalization_replace import ada_groupnorm_construct, ada_layernorm_construct, \
    ada_layernorm_continuous_construct, ada_layernormzero_construct
...
class StableDiffusion3PipelineBoost(DiffusionPipeline):
    r"""
    Args:
