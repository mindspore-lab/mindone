...
from mindspore import Parameter, ParameterTuple, RunContext, Tensor, mint
from mindspore.train import Callback

from mindone.trainers.checkpoint import CheckpointManager

__all__ = ["LossMonitor", "SaveCkptCallback"]
...
class LossMonitor(Callback):
    ...
    def _fetch_optimizer_lr(self, cb_params) -> Tensor:
        ...
        if opt.dynamic_lr:
            lr = opt.learning_rate(mint.clamp(opt.global_step - 1, min=0))[0]
        return lr
