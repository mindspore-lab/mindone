...
def get_2d_rotary_pos_embed_from_grid(embed_dim, grid, use_real=True):
...
def get_1d_rotary_pos_embed(dim: int, pos: Union[np.ndarray, int], theta: float = 10000.0, use_real=True):
    """
    ...
    if use_real:
        ...
        raise NotImplementedError("complex64 is not yet supported.")
