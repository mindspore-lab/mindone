# Adapted from https://github.com/whlzy/FiT/blob/master/fit/scheduler/improved_diffusion/diffusion_utils.py
...
def mean_flat(tensor: Tensor, mask: Optional[Tensor] = None):
    """
    ...
    tensor = ops.masked_fill(tensor, ~mask, 0.0)
