...
def preprocess_fn(image_in: np.ndarray, remove_bg: bool, recenter: bool, working_dir):
    ...
    assert success, "Failed under preprocess_fn!"
    return image_out
...
def demo_openlrm(infer_impl):
    ...
    _DESCRIPTION = """
        <div>
            <a style="display:inline-block" href='https://github.com/3DTopia/OpenLRM'>
            <img src='https://img.shields.io/github/stars/3DTopia/OpenLRM?style=social'/></a>
            <a style="display:inline-block; margin-left: .5em" href="https://huggingface.co/zxhezexin">
            <img src='https://img.shields.io/badge/Model-Weights-blue'/></a>
        </div>
