...
export TRAIN_CONFIG="./config/train-sample-base.yaml"
export DEVICE_ID=0
EPOCH=100000
OUTPUT_PATH=./outputs/train_3sample_1card_e$EPOCH
python -m openlrm.launch train.lrm --config $INFER_CONFIG --mode 1 --num_parallel_workers 1 --epochs $EPOCH &> train_${DEVICE_ID}_3sample_1card_e${EPOCH}.log &
