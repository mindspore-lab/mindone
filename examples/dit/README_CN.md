...
我们参考[DiT的官方仓库](https://github.com/facebookresearch/DiT)下载预训练检查点。目前，只有两个检查点`DiT-XL-2-256x256`和`DiT-XL-2-512x512`可用。
...
| 模型名称 | 环境 | 卡数 | 图像尺寸 | 图构建编译 | 批量大小 | 重计算 | 数据下沉模式 | 每步时间 | 训练图像/秒 |
| :--------: | :----: | :---: | :--------: | :-----------: | :--: | :-------: | :--: | :-------: | :-----------: |
