...
from mindone.transformers.models.speechT5 import SpeechT5HifiGan
from mindone.transformers.models.clap import ClapTextModelWithProjection
from mindnlp.transformers import RobertaTokenizer, RobertaTokenizerFast
...
from mindone.diffusers.pipelines.pipeline_utils import AudioPipelineOutput, DiffusionPipeline
...
class AudioLDMPipeline(DiffusionPipeline):
    ...
    def _encode_prompt(
        ...
        if prompt_embeds is None:
            ...
            prompt_embeds = ops.L2Normalize(axis=-1,epsilon=1e-12)(prompt_embeds)
        ...
        if do_classifier_free_guidance and negative_prompt_embeds is None:
            ...
            # additional L_2 normalization over each hidden-state
            negative_prompt_embeds = ops.L2Normalize(axis=-1,epsilon=1e-12)(negative_prompt_embeds)
    ...
    def decode_latents(self, latents):
        ...
        mel_spectrogram = self.vae.decode(latents,return_dict=True).sample
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                latents = self.scheduler.step(noise_pred, t, latents, return_dict=True, **extra_step_kwargs).prev_sample
