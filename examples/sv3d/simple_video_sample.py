...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--device_id", default=2, type=int, help="MindSpore HW device id"
    )
    parser.add_argument(
        "--decoding_t", default=7, type=int, help="# of decoding steps"
    )
    parser.add_argument(
        "--version", default="sv3d_u", choices=["sv3d_u", "sv3d_u_overfitted_ckpt"], type=str
    )
