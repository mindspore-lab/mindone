...
from sgm.util import append_dims, clip_grad_, clip_grad_global_, get_timestep_multinomial
...
class TrainerMultiGraphTwoStage:
    def __init__(self, engine, optimizers, reducers, scaler, overflow_still_update=True, amp_level="O2"):
        ...
        if amp_level:
            from sgm.util import auto_mixed_precision
            ...
            disable_first_stage_autocast = engine.disable_first_stage_autocast
            if disable_first_stage_autocast:
