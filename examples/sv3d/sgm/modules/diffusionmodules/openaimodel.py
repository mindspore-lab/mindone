...
class ResBlock(TimestepBlock):
    ...
    def __init__(
        ...
        if isinstance(kernel_size, Iterable):
            ...
            kernel_size = tuple(kernel_size)  # kernel size may be passed in as ListConfig, ok for torch but not for ms
        else:
...
class UNetModel_lora(UNetModel):
    def __init__(
        ...
        from sgm.modules.attention import CrossAttention, MemoryEfficientCrossAttention
        from sgm.modules.lora import Dense as Dense_lora
        from sgm.modules.lora import mark_only_lora_as_trainable
