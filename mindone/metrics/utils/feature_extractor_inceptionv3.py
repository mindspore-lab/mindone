...
class InceptionA(nn.Cell):
    def __init__(
        ...
        self.branch1 = nn.SequentialCell(
            [BasicConv2d(in_channels, 48, kernel_size=1), BasicConv2d(48, 64, kernel_size=5)]
        )
        ...
        self.branch_pool = nn.SequentialCell(
            [nn.AvgPool2d(kernel_size=3, pad_mode="same"), BasicConv2d(in_channels, pool_features, kernel_size=1)]
        )
...
class InceptionC(nn.Cell):
    def __init__(
        ...
        self.branch_pool = nn.SequentialCell(
            [nn.AvgPool2d(kernel_size=3, pad_mode="same"), BasicConv2d(in_channels, 192, kernel_size=1)]
        )
...
class InceptionE1(nn.Cell):
    def __init__(self, in_channels: int) -> None:
        ...
        self.branch2 = nn.SequentialCell(
            [BasicConv2d(in_channels, 448, kernel_size=1), BasicConv2d(448, 384, kernel_size=3)]
        )
