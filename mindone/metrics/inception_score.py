...
logger = logging.getLogger("mindone.metrics.inception_score")


class InceptionScore(Cell):
    ...
    def construct(self, x: Tensor):
        self.print("updating inside")
        x = (x * 255).to(mindspore.uint8) if self.normalize else x
