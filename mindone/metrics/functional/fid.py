...
logger = logging.getLogger("mindone.metrics.functional.fid")
...
def _compute(real_features_sum, real_features_cov_sum, real_features_num_samples, fake_features_sum,
             fake_features_cov_sum, fake_features_num_samples):
...
def fid(
    ...
    return _compute(real_features_sum, real_features_cov_sum, real_features_num_samples,
