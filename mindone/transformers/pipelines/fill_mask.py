...
class FillMaskPipeline(Pipeline):
    ...
    [{'score': 0.042, 'token': 3291, 'token_str': 'problem', 'sequence': 'this is a simple problem.'}, {'score': 0.031, 'token': 3160, 'token_str': 'question', 'sequence': 'this is a simple question.'},
    {'score': 0.03, 'token': 8522, 'token_str': 'equation', 'sequence': 'this is a simple equation.'}, {'score': 0.027, 'token': 2028, 'token_str': 'one', 'sequence': 'this is a simple one.'},
    ...
    def preprocess(
        ...
        for key in model_inputs.keys():
            model_input[key] = ms.tensor(model_inputs[key])
        return model_input
