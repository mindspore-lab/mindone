...
class PipelineIterator:
    ...
    def loader_batch_item(self):
        ...
        """
        if isinstance(self._loader_batch_data, ms.Tensor):
            ...
            for k, element in self._loader_batch_data.items():
                if isinstance(element, ModelOutput):
                    ...
                    if isinstance(element[0], ms.Tensor):
                ...
                elif isinstance(element[self._loader_batch_index], ms.Tensor):
    ...
    def __next__(self):
        ...
        if self.loader_batch_size is not None:
            ...
            if isinstance(processed, ms.Tensor):
