...
import numpy as np
from transformers.configuration_utils import PretrainedConfig, WatermarkingConfig
...
class BayesianDetectorWatermarkedLikelihood(nn.Cell):
    ...
    def __init__(self, watermarking_depth: int):
        ...
        super().__init__()
        self.watermarking_depth = watermarking_depth
        self.beta = Parameter(-2.5 + 0.001 * mint.randn(1, 1, watermarking_depth))
        self.delta = Parameter(0.001 * mint.randn(1, 1, self.watermarking_depth, watermarking_depth))
...
class BayesianDetectorModel(PreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.prior = Parameter(ms.tensor([self.base_rate]))
