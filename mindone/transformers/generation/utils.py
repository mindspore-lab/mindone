...
class GenerationMixin:
            ...
            for key in dict_to_expand:
                if (
                    ...
                    if dict_to_expand[key].dtype == ms.bool_:
                        dict_to_expand[key] = dict_to_expand[key].astype(ms.int32)
                        dtype = dict_to_expand[key].dtype
                    dict_to_expand[key] = dict_to_expand[key].repeat_interleave(expand_size, dim=0)
                    if dtype:
                        dict_to_expand[key] = dict_to_expand[key].astype(dtype)
    ...
    def generate(
        ...
        **kwargs,
        ...
        Parameters:
            ...
            assistant_model (`MSPreTrainedModel`, *optional*):
        ...
        # FIXME logitsprocessorList, StoppingCriteriaList
        ...
        if generation_config.cache_implementation is not None and (model_kwargs.get(cache_name) is not None):
            ...
            if generation_config.cache_implementation in NEED_SETUP_CACHE_CLASSES_MAPPING:
                ...
                raise RuntimeError("MindOne do not support quantized generation.")
    ...
    def _dola_decoding(
        ...
        **model_kwargs,
        ...
        while self._has_unfinished_sequences(this_peer_finished, synced_gpus, device=None):
...
def _relative_top_filter(
    ...
    probs_max = ops.max(scores_normalized, axis=-1).values
