    ...
    def _update_full_mask(
        ...
        if attention_mask is not None:
            if self.config._attn_implementation == "flash_attention_2":
                ...
                raise ValueError("flex not support.")
            else:
                # [bsz, seq_len] -> [bsz, 1, tgt_seq_len, src_seq_len]
...
class Speech2TextDecoder(Speech2TextPreTrainedModel):
    ...
    def construct(
        ...
        hidden_states = mint.functional.dropout(hidden_states, p=self.dropout, training=self.training)
    ...
    def _update_causal_mask(
        ...
        if self.config._attn_implementation == "flash_attention_2":
            ...
            raise ValueError("flex not supported.")
        else:
