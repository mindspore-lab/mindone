...
# from ..video_utils import VideoInput, make_batched_videos # FIXME: uncomment when synchronized to latest transformers
...
class Qwen2_5OmniProcessor(ProcessorMixin):
    ...
    def __call__(
        ...
        **kwargs: Unpack[Qwen2_5OmniProcessorKwargs],
        ...
        if videos is not None:
            ...
            # FIXME: uncomment when Qwen2VLVideoProcessor supports non-torch inputs
    ...
    def replace_multimodal_special_tokens(
        ...
        # merge_length_video = self.video_processor.merge_size**2 # FIXME: wait for video_processor to support numpy or mindspore
        merge_length_video = self.image_processor.merge_size**2
