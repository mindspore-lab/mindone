...
class OwlViTPreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        if isinstance(module, OwlViTTextEmbeddings):
            ...
            normal_(module.text_projection.weight, std=module.text_embed_dim**-0.5 * self.config.initializer_factor)
            normal_(
...
class OwlViTEncoder(nn.Cell):
    ...
    def __init__(self, config: OwlViTConfig):
        super().__init__()
        self.layers = nn.CellList([OwlViTEncoderLayer(config) for _ in range(config.num_hidden_layers)])
...
class OwlViTTextModel(OwlViTPreTrainedModel):
    ...
    def construct(
        ...
        >>> from mindone.transformers import AutoProcessor, OwlViTTextModel

        >>> model = OwlViTTextModel.from_pretrained("google/owlvit-base-patch32")
        >>> processor = AutoProcessor.from_pretrained("google/owlvit-base-patch32")
        >>> inputs = processor(text=[["a photo of a cat", "a photo of a dog"], ["photo of an astronaut"]], return_tensors="np")
...
class OwlViTVisionModel(OwlViTPreTrainedModel):
    ...
    def construct(
        ...
        >>> from mindone.transformers import AutoProcessor, OwlViTVisionModel
...
class OwlViTModel(OwlViTPreTrainedModel):
    ...
    def get_text_features(
        ...
        >>> from mindone.transformers import AutoProcessor, OwlViTModel
...
class OwlViTClassPredictionHead(nn.Cell):
    ...
    def construct(
        self, image_embeds: ms.Tensor, query_embeds: Optional[ms.Tensor], query_mask: Optional[ms.Tensor]
        ...
        if query_mask is not None:
            ...
            pred_logits = mint.where(query_mask == 0, _DTYPE_2_MIN[pred_logits.dtype], pred_logits)
...
class OwlViTForObjectDetection(OwlViTPreTrainedModel):
    ...
    def box_predictor(
        self, image_feats: ms.Tensor, feature_map: ms.Tensor, interpolate_pos_encoding: bool = False
    ) -> ms.Tensor:
        """
        Args:
            image_feats:
    ...
    def class_predictor(
        self, image_feats: ms.Tensor, query_embeds: Optional[ms.Tensor] = None, query_mask: Optional[ms.Tensor] = None
    ) -> Tuple[ms.Tensor]:
        """
        Args:
            image_feats:
    ...
    def image_text_embedder(
        ...
        new_size = (image_embeds.shape[0], num_patches_height, num_patches_width, image_embeds.shape[-1])
    ...
    def embed_image_query(
        self, query_image_features: ms.Tensor, query_feature_map: ms.Tensor, interpolate_pos_encoding: bool = False
    ) -> ms.Tensor:
    ...
    def image_guided_detection(
        ...
        >>> from mindone.transformers import AutoProcessor, OwlViTForObjectDetection

        >>> processor = AutoProcessor.from_pretrained("google/owlvit-base-patch16")
        >>> model = OwlViTForObjectDetection.from_pretrained("google/owlvit-base-patch16", revision="refs/pr/9")
    ...
    def construct(
        ...
        >>> from mindone.transformers import OwlViTForObjectDetection, OwlViTProcessor
