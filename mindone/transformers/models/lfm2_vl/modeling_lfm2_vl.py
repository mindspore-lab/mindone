    ...
    def get_placeholder_mask(
        ...
        if input_ids is None:
            special_image_mask = inputs_embeds == self.get_input_embeddings()(
                mindspore.Tensor(self.config.image_token_id, dtype=mindspore.int64, )
            )
...
class Lfm2VlForConditionalGeneration(Lfm2VlPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config: Lfm2VlConfig):
        ...
        self.lm_head = mindspore.mint.nn.Linear(config.text_config.hidden_size, config.text_config.vocab_size, bias=False)
        self.post_init()
