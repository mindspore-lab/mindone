...
class GraniteMoeSharedMLP(nn.Cell):
    """
...
class GraniteMoeSharedRMSNorm(nn.Cell):
...
class GraniteMoeSharedParallelExperts(nn.Cell):
    ...
    def construct(self, inputs, expert_size):
        """
        construct pass of the GraniteMoeSharedParallelExperts module.
        Args:
            inputs (Tensor):
                Input tensor.
            expert_size:
...
class GraniteMoeSharedTopKGating(nn.Cell):
...
class GraniteMoeSharedMoE(nn.Cell):
    """
...
class GraniteMoeSharedAttention(nn.Cell):
...
class GraniteMoeSharedDecoderLayer(nn.Cell):
