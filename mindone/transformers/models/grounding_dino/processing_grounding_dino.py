...
class GroundingDinoProcessor(ProcessorMixin):
    ...
    def batch_decode(self, *args, **kwargs):
        """
        This method constructs all its arguments to PreTrainedTokenizer's [`~PreTrainedTokenizer.batch_decode`]. Please
    ...
    def decode(self, *args, **kwargs):
        """
        This method constructs all its arguments to PreTrainedTokenizer's [`~PreTrainedTokenizer.decode`]. Please refer to
    ...
    def post_process_grounded_object_detection(
        ...
        batch_probs = mint.sigmoid(batch_logits)  # (batch_size, num_queries, 256)
        batch_scores = mint.max(batch_probs, dim=-1)[0]  # (batch_size, num_queries)
