    ...
    def preprocess(
        ...
        Args:
            ...
            return_tensors (`str` or `TensorType`, *optional*):
                ...
                - `TensorType.MINDSPORE` or `'pt'`: Return a batch of type `mindspore.Tensor`.
        ...
        if not valid_images(images):
            raise ValueError("Invalid image type. Must be of type PIL.Image.Image, numpy.ndarray, " "mindspore.Tensor")
