...
class ArceeRotaryEmbedding(nn.Cell):
    def __init__(self, config: ArceeConfig):
        ...
        # FIXME: register_buffer can't be changed dtype by set_dtype
        self.inv_freq = ms.Parameter(inv_freq, name="inv_freq")
...
class ArceeForCausalLM(ArceePreTrainedModel, GenerationMixin):
    ...
    def construct(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from mindone.transformers import ArceeForCausalLM
