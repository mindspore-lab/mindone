...
class HunYuanMoEV1RMSNorm(nn.Cell):
...
class HunYuanMoEV1Attention(nn.Cell):
...
class HunYuanMoEV1Gate(nn.Cell):
...
class HunYuanMoEV1ForCausalLM(HunYuanMoEV1PreTrainedModel, GenerationMixin):
    ...
    def construct(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> from mindone.transformers import HunYuanMoEV1ForCausalLM
        >>> import mindspore as ms
