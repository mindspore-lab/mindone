...
class BlenderbotSmallLearnedPositionalEmbedding(mint.nn.Embedding):
    """
...
class BlenderbotSmallEncoder(BlenderbotSmallPreTrainedModel):
    ...
    def __init__(self, config: BlenderbotSmallConfig, embed_tokens: Optional[mint.nn.Embedding] = None):
