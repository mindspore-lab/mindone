...
class BigBirdPegasusBlockSparseAttention(nn.Cell):
    ...
    def bigbird_block_sparse_attention(
        ...
        # attention is calculated separately for q[0], q[1], q[2:-2], q[-2], q[-1] in order to use special trick of shifting tokens
        # (for calculating sliding attention)
        ...
        # [b, n_heads, from_seq_len//from_block_size-4, 3*to_block_size, -1]
        ...
        # [bsz, n_heads, to_block_size, -1] ==> [bsz, n_heads, from_seq_len//from_block_size-4, from_block_size, to_block_size]
