...
class MoonshineEncoder(MoonshinePreTrainedModel):
    ...
    def __init__(self, config: MoonshineConfig):
        ...
        self.conv1 = nn.Conv1d(1, embed_dim, kernel_size=127, stride=64, has_bias=False, pad_mode="valid")
        self.conv2 = nn.Conv1d(embed_dim, 2 * embed_dim, kernel_size=7, stride=3, has_bias=True, pad_mode="valid")
        self.conv3 = nn.Conv1d(2 * embed_dim, embed_dim, kernel_size=3, stride=2, has_bias=True, pad_mode="valid")
