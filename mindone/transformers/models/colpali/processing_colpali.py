...
def pad_sequence(
    sequences: Union[ms.Tensor, list[ms.Tensor]],
...
class ColPaliProcessor(ProcessorMixin):
    ...
    def __call__(
        ...
        **kwargs: Unpack[ColPaliProcessorKwargs],
        ...
        When preparing the the text(s), this method constructs the `text` and `kwargs` arguments to LlamaTokenizerFast's
        [`~LlamaTokenizerFast.__call__`].
        When preparing the the image(s), this method constructs the `images` and `kwargs` arguments to SiglipImageProcessor's
    ...
    def batch_decode(self, *args, **kwargs):
        """
        This method constructs all its arguments to GemmaTokenizerFast's [`~PreTrainedTokenizer.batch_decode`]. Please
    ...
    def decode(self, *args, **kwargs):
        """
        This method constructs all its arguments to GemmaTokenizerFast's [`~PreTrainedTokenizer.decode`]. Please refer to
    ...
    def process_images(
        ...
        **kwargs: Unpack[ColPaliProcessorKwargs],
        ...
        This method constructs the `images` and `kwargs` arguments to SiglipImageProcessor's [`~SiglipImageProcessor.__call__`].
    ...
    def process_queries(
        ...
        **kwargs: Unpack[ColPaliProcessorKwargs],
        ...
        This method constructs the `text` and `kwargs` arguments to LlamaTokenizerFast's [`~LlamaTokenizerFast.__call__`].
    ...
    def score_retrieval(
        ...
        Args:
            ...
            output_dtype (ms.Type`, *optional*, defaults to `ms.float32`): The dtype of the output tensor.
        ...
        for i in range(0, len(query_embeddings), batch_size):
            ...
            scores.append(mint.cat(batch_scores, dim=1).to(output_dtype))
