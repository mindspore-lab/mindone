...
class NemotronSdpaAttention(NemotronAttention):
    """
    Nemotron attention module using mint.nn.functional.scaled_dot_product_attention. This module inherits from
    ...
    def construct(
        ...
        **kwargs,
        ...
        if output_attentions:
            ...
            logger.warning_once(
                "NemotronModel is using NemotronSdpaAttention, but `mint.nn.functional.scaled_dot_product_attention` "
...
class NemotronModel(NemotronPreTrainedModel):
    ...
    def _update_causal_mask(
        self,
        attention_mask: Union[ms.Tensor],
...
class NemotronForCausalLM(NemotronPreTrainedModel, GenerationMixin):
    ...
    def construct(
        ...
        **loss_kwargs,
        ...
        >>> from mindone.transformers import NemotronForCausalLM
        >>> import mindspore as ms
