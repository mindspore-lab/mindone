...
class GraniteMoeHybridAttention(nn.Cell):
    ...
    def construct(
        ...
        position_embeddings: Optional[tuple[ms.Tensor, ms.Tensor]] = None,  # None or rope embeddings
        **kwargs,
...
class HybridMambaAttentionDynamicCache:
    ...
    def __init__(self, config: GraniteMoeHybridConfig, batch_size, dtype=ms.float16):
...
def segment_sum(input_tensor):
    ...
    tensor_segsum = tensor_segsum.masked_fill(~mask, -ms.tensor(float("inf")))
...
class GraniteMoeHybridMambaLayer(nn.Cell):
    """
    ...
    def slow_forward(
        ...
        if use_precomputed_states:
            ...
            hidden_states_B_C = mint.sum(conv_states * self.conv1d.weight.squeeze(1).squeeze(1), dim=-1)
    ...
    def construct(
        ...
        cache_position: Optional[ms.Tensor] = None,
        attention_mask: Optional[ms.Tensor] = None,
        seq_idx: Optional[ms.Tensor] = None,
        **kwargs,
    ):
...
class GraniteMoeHybridRMSNormGated(ms.nn.Cell):
...
class GraniteMoeHybridMLP(nn.Cell):
    """
    ...
    def __init__(self, config: GraniteMoeHybridConfig):
        ...
        self.input_linear = mint.nn.Linear(self.input_size, self.hidden_size * 2, bias=False)
        self.output_linear = mint.nn.Linear(self.hidden_size, self.input_size, bias=False)
...
class GraniteFlashAttentionKwargs(TypedDict, total=False):
    ...
    Use cases include padding-free training.

    Attributes:
        cu_seq_lens_q (`ms.Tensor`)
            Gets cumulative sequence length for query state.
        cu_seq_lens_k (`ms.Tensor`)
...
class GraniteMoeHybridRMSNorm(nn.Cell):
    def __init__(self, hidden_size, eps=1e-6):
        """
...
class GraniteMoeHybridParallelExperts(nn.Cell):
    def __init__(self, num_experts: int, input_size: int, output_size: int) -> None:
        ...
        """
        super().__init__()
        self.weight = ms.Parameter(mint.empty(num_experts, output_size, input_size), name="weight")
...
class GraniteMoeHybridTopKGating(nn.Cell):
    def __init__(self, input_size: int, num_experts: int, top_k: int):
        ...
        self.layer = mint.nn.Linear(input_size, num_experts, bias=False)
...
class GraniteMoeHybridMoE(nn.Cell):
    """
...
class GraniteMoeHybridRotaryEmbedding(nn.Cell):
...
def load_balancing_loss_func(
    ...
    if attention_mask is None:
        ...
        router_per_expert_attention_mask = (
            ...
            .broadcast_to((num_hidden_layers, batch_size, sequence_length, routing_weights.shape[1]))
...
class GraniteMoeHybridForCausalLM(GraniteMoeHybridPreTrainedModel, GenerationMixin):
    ...
    def construct(
        ...
        **kwargs,
        ...
        >>> from mindone.transformers import GraniteMoeHybridForCausalLM
        >>> import mindspore as ms
