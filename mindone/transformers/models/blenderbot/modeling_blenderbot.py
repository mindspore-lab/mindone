...
class BlenderbotLearnedPositionalEmbedding(mint.nn.Embedding):
    """
    ...
    def construct(self, input_ids_shape: ops.Size, past_key_values_length: int = 0):
...
class BlenderbotScaledWordEmbedding(mint.nn.Embedding):
    """
...
class BlenderbotEncoder(BlenderbotPreTrainedModel):
    ...
    def __init__(self, config: BlenderbotConfig, embed_tokens: Optional[mint.nn.Embedding] = None):
