...
class Kosmos2_5TextTransformer(mindspore.nn.Cell):
    ...
    def __init__(self, config: Kosmos2_5TextConfig):
        ...
        self.layers = mindspore.nn.CellList([Kosmos2_5TextBlock(config, layer_idx) for layer_idx in range(config.layers)])
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        if image_embeds_position_mask is not None:
            ...
            zero_emb = self.segment_emb(
                mindspore.mint.zeros((bsz, 1), dtype=mindspore.int64, )
            )
            positions += zero_emb
        ...
        if past_key_values is not None:
            ...
            image_embeds_position_mask = mindspore.mint.cat(
                (
                    ...
                    mindspore.mint.zeros(size=(batch_size, seq_len - mask_len), dtype=mindspore.bool_, ),
                ),
                dim=1,
            )
