...
# similar to transformers.models.pix2struct.image_processing_pix2struct.Pix2StructImageProcessor, but delete is_vqa and additionally
# return width and height after resizing
    ...
    def preprocess(
        ...
        **kwargs,
        ...
        for image in images:
            ...
            # convert to mindspore tensor and permute
