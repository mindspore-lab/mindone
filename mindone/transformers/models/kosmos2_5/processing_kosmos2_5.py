...
class Kosmos2_5Processor(ProcessorMixin):
    ...
    def __init__(self, image_processor, tokenizer):
        ...
        )  # "<s>" : within a <image> ... </image> pair, these <s> tokens indicate they are positions reserved for an image
    ...
    def __call__(
        ...
        **kwargs: Unpack[Kosmos2_5ProcessorKwargs],
        ...
        if text is not None:
            ...
            image_embeds_position_mask = mindspore.Tensor(image_embeds_position_mask).unsqueeze(0).repeat(batch_size, 1)
