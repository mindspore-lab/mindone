...
class EncoderDecoderModel(PreTrainedModel, GenerationMixin):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        if from_tf:
            raise NotImplementedError("`from_tf` is not supported")
    ...
    def construct(
        ...
        **kwargs,
        ...
        >>> input_ids = ms.tensor(tokenizer("This is a really long text", return_tensors="np").input_ids)
        >>> labels = ms.tensor(tokenizer("This is the corresponding summary", return_tensors="np").input_ids)
