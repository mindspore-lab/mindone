...
class OneFormerImageProcessor(BaseImageProcessor):
    ...
    def encode_inputs(
        ...
        Args:
            ...
            return_tensors (`str` or [`~file_utils.TensorType`], *optional*):
                If set, will return tensors instead of NumPy arrays. If set to `'pt'`, return PyTorch `ms.Tensor`
                objects.
        ...
        if annotations is not None:
            ...
            for i, label in enumerate(annotations):
                ...
                class_labels.append(ms.Tensor(classes).long())
    ...
    def post_process_instance_segmentation(
        ...
        results: List[Dict[str, ms.Tensor]] = []
        ...
        for i in range(batch_size):
            ...
            if task_type == "panoptic":
                keep = mint.zeros_like(scores_per_image).bool()
