...
class GraniteAttention(nn.Cell):
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        if self.config._attn_implementation != "eager":
            if self.config._attn_implementation == "sdpa" and kwargs.get("output_attentions", False):
                logger.warning_once(
                    "nn.functional.scaled_dot_product_attention` does not support `output_attentions=True`. Falling back to "
...
class GraniteDecoderLayer(nn.Cell):
...
class GraniteRotaryEmbedding(nn.Cell):
