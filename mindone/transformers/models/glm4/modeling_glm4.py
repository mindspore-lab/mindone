...
class Glm4RotaryEmbedding(nn.Cell):
...
class Glm4Model(Glm4PreTrainedModel):
    ...
    def construct(
        ...
        **flash_attn_kwargs: Unpack[FlashAttentionKwargs],
        ...
        # (input_ids is None) ^ (inputs_embeds is not None) is not supported in graph mode
...
class Glm4ForCausalLM(Glm4PreTrainedModel, GenerationMixin):
    ...
    def construct(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> from mindone.transformers import Glm4ForCausalLM
        >>> import mindspore as ms
