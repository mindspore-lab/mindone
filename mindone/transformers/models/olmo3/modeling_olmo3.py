...
class Olmo3Attention(ms.nn.Cell):
...
class Olmo3RotaryEmbedding(ms.nn.Cell):
...
class Olmo3Model(Olmo3PreTrainedModel):
    def __init__(self, config: Olmo3Config):
        ...
        self.rotary_embs = ms.nn.CellDict(
            {
