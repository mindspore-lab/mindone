...
class Olmo3RMSNorm(mindspore.nn.Cell):
...
class Olmo3Attention(mindspore.nn.Cell):
...
class Olmo3MLP(mindspore.nn.Cell):
...
class Olmo3RotaryEmbedding(mindspore.nn.Cell):
...
class Olmo3Model(Olmo3PreTrainedModel):
    def __init__(self, config: Olmo3Config):
        ...
        self.rotary_embs = mindspore.nn.CellDict(
            {
