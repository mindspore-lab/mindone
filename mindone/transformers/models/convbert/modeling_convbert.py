...
class SeparableConv1D(nn.Cell):
    ...
    def __init__(self, config, input_filters, output_filters, kernel_size, **kwargs):
        ...
        self.pointwise = nn.Conv1d(
            input_filters, output_filters, kernel_size=1, has_bias=False, pad_mode="pad", padding=0
        )
...
class ConvBertSelfAttention(nn.Cell):
    ...
    def construct(
        ...
        # conv and context
        new_context_layer_shape = context_layer.shape[:-2] + (self.num_attention_heads * self.attention_head_size * 2,)
...
CONVBERT_START_DOCSTRING = r"""
    This model is a MindSpore [nn.Cell](https://www.mindspore.cn/docs/en/r2.5.0/api_python/nn/mindspore.nn.Cell.html) sub-class. Use
