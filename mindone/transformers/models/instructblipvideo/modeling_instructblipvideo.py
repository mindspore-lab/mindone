...
from transformers.models.instructblipvideo.configuration_instructblipvideo import (
...
class InstructBlipVideoForConditionalGeneration(InstructBlipVideoPreTrainedModel, GenerationMixin):
    ...
    def construct(
        ...
        "A person is eating a bowl of pasta, and they are using a fork to eat it. The person is sitting at a table, and the plate of pasta is on the
        table in front"
        ```"""
        return_dict = return_dict if return_dict is not None else self.config.use_return_dict
        ...
        if getattr(self.config, "video_token_index", None) is not None:
            ...
            logger.warning_once(
                ...
                "Please follow instruction here (https://gist.github.com/zucchini-nlp/65f22892b054dc0d68228af56fbeaac2) to update "
                "your InstructBLIPVideo model. "
    ...
    def generate(
        ...
        **generate_kwargs,
        ...
        if getattr(self.config, "video_token_index", None) is not None:
            ...
            logger.warning_once(
                "Expanding inputs for video tokens in InstructBLIPVideo should be done in processing. "
                "Please follow instruction here (https://gist.github.com/zucchini-nlp/65f22892b054dc0d68228af56fbeaac2) to update your "
