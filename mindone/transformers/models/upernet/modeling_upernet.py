...
"""MindSpore UperNet model. Based on OpenMMLab's implementation, found in https://github.com/open-mmlab/mmsegmentation."""
...
class UperNetForSemanticSegmentation(UperNetPreTrainedModel):
    ...
    def construct(
        ...
        if self.auxiliary_head is not None:
            ...
            auxiliary_logits = mint.nn.functional.interpolate(
