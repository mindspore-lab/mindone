...
class ApertusRotaryEmbedding(nn.Cell):
...
class ApertusAttention(nn.Cell):
...
class ApertusForCausalLM(ApertusPreTrainedModel, GenerationMixin):
    ...
    def construct(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> from mindone.transformers import ApertusForCausalLM
        >>> import mindspore as ms

        >>> model = ApertusForCausalLM.from_pretrained("swiss-ai/Apertus-8B-2509")
