...
class SamHQProcessor(ProcessorMixin):
    ...
    def _preprocess_input(self, inputs, error_message, expected_nesting=1, dtype=None):
        """
        Preprocess input by converting mindspore tensors to numpy arrays and validating structure.
        ...
        # Convert mindspore tensor to list if applicable
    ...
    def _check_and_preprocess_points(
        ...
        are, it converts the coordinates of the points and bounding boxes. If a user passes directly a `ms.Tensor`,
    ...
    def _to_tensor(self, array, min_dim, return_tensors):
        ...
        Args:
            ...
            return_tensors: The type of tensors to return (e.g., "ms" for MindSpore tensors)
        Returns:
            The converted array or tensor with proper dimensions
        """
        if return_tensors == "ms":
            array = ms.tensor(array)
