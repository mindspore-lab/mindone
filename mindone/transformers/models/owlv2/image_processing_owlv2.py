...
def _scale_boxes(boxes, target_sizes):
    ...
    max_size = mindspore.mint.max(image_height, image_width)

    scale_factor = mindspore.mint.stack([max_size, max_size, max_size, max_size], dim=1)
        ...
        Args:
            ...
            return_tensors (`str` or `TensorType`, *optional*):
                The type of tensors to return. Can be one of:
                    ...
                    - `TensorType.PYTORCH` or `'ms'`: Return a batch of type `ms.Tensor`.
