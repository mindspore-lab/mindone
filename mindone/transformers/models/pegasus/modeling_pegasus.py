...
class PegasusSinusoidalPositionalEmbedding(mint.nn.Embedding):
    ...
    @staticmethod
    def _init_weight(out: ms.Parameter) -> ms.Parameter:
        """
...
PEGASUS_GENERATION_EXAMPLE = r"""
    ...
    >>> from mindone.transformers import PegasusForConditionalGeneration
    >>> import mindspore as ms
...
class PegasusEncoder(PegasusPreTrainedModel):
    ...
    def __init__(self, config: PegasusConfig, embed_tokens: Optional[mint.nn.Embedding] = None):
...
class PegasusForCausalLM(PegasusPreTrainedModel, GenerationMixin):
    ...
    def construct(
        ...
        ```python
        >>> from transformers import AutoTokenizer
        >>> from mindone.transformers import PegasusForCausalLM
        >>> import mindspore as ms
