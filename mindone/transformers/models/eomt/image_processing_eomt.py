...
def compute_segments(
    ...
    segmentation = mint.zeros((height, width), dtype=ms.int64) - 1
    segments: list[dict] = []
...
class EomtImageProcessor(BaseImageProcessor):
    ...
    def _preprocess_mask(
        ...
        return ms.Tensor.from_numpy(segmentation_map)
    ...
    def preprocess(
        ...
        Args:
            ...
            return_tensors (`str` or `TensorType`, *optional*):
                The type of tensors to return. Can be `"ms"` or `"np"`.
        ...
        if do_split_image and patch_offsets:
            encoded_inputs["patch_offsets"] = [ms.tensor(offsets) for offsets in patch_offsets]
    ...
    def encode_inputs(
        ...
        Args:
            ...
            return_tensors (`str` or [`~file_utils.TensorType`], *optional*):
                If set, will return tensors instead of NumPy arrays. If set to `'ms'`, return MindSpore `ms.Tensor`
                objects.
