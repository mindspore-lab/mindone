...
class Qwen3MoeAttention(mindspore.nn.Cell):
...
class Qwen3MoeMLP(mindspore.nn.Cell):
...
class Qwen3MoeSparseMoeBlock(mindspore.nn.Cell):
...
class Qwen3MoeRMSNorm(mindspore.nn.Cell):
...
class Qwen3MoeDecoderLayer(mindspore.nn.Cell):
    def __init__(self, config: Qwen3MoeConfig, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size
...
class Qwen3MoeRotaryEmbedding(mindspore.nn.Cell):
...
class Qwen3MoeForCausalLM(Qwen3MoePreTrainedModel, GenerationMixin):
    ...
    def construct(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> from mindone.transformers import Qwen3MoeForCausalLM
