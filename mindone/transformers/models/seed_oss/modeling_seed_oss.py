...
class SeedOssRMSNorm(mindspore.nn.Cell):
...
class SeedOssMLP(mindspore.nn.Cell):
    ...
    def construct(self, x):
        ...
        down_proj = mindspore.mint.nn.functional.dropout(down_proj, p=self.residual_dropout, training=self.training)
        return down_proj
...
class SeedOssAttention(mindspore.nn.Cell):
    ...
    def construct(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        attn_output = mindspore.mint.nn.functional.dropout(attn_output, p=self.residual_dropout, training=self.training)
...
class SeedOssRotaryEmbedding(mindspore.nn.Cell):
