...
class SuperPointConvBlock(mindspore.nn.Cell):
    def __init__(
...
class SuperPointEncoder(mindspore.nn.Cell):
    """
    ...
    def __init__(self, config: SuperPointConfig) -> None:
        ...
        self.conv_blocks = mindspore.nn.CellList(conv_blocks)
...
class SuperPointInterestPointDecoder(mindspore.nn.Cell):
    """
    ...
    def construct(self, encoded: mindspore.Tensor) -> Tuple[mindspore.Tensor, mindspore.Tensor]:
...
class SuperPointDescriptorDecoder(mindspore.nn.Cell):
    """
    ...
    def construct(self, encoded: mindspore.Tensor, keypoints: mindspore.Tensor) -> mindspore.Tensor:
