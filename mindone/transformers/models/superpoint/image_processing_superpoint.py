...
class SuperPointImageProcessor(BaseImageProcessor):
    ...
    def post_process_keypoint_detection(
        ...
        if isinstance(target_sizes, List):
            image_sizes = ms.Tensor(target_sizes, )
        else:
