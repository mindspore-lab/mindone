...
class ChineseCLIPProcessor(ProcessorMixin):
    ...
    def __call__(
        ...
        **kwargs: Unpack[ChineseClipProcessorKwargs],
        ...
        """
        Main method to prepare for the model one or several sequences(s) and image(s). This method constructs the `text`
        and `kwargs` arguments to BertTokenizerFast's [`~BertTokenizerFast.__call__`] if `text` is not `None` to encode
        the text. To prepare the image(s), this method constructs the `images` and `kwrags` arguments to
        ...
        if text is not None:
            ...
            encoding = self.tokenizer(text, **output_kwargs["text_kwargs"], return_tensors="np")
        ...
        if text is not None and images is not None:
            ...
            encoding = BatchEncoding(data=dict(**image_features), tensor_type="np")
    ...
    def batch_decode(self, *args, **kwargs):
        """
        This method constructs all its arguments to BertTokenizerFast's [`~PreTrainedTokenizer.batch_decode`]. Please
    ...
    def decode(self, *args, **kwargs):
        """
        This method constructs all its arguments to BertTokenizerFast's [`~PreTrainedTokenizer.decode`]. Please refer to
