...
class DeepseekV3RotaryEmbedding(mindspore.nn.Cell):
...
class DeepseekV3MLP(mindspore.nn.Cell):
...
class DeepseekV3TopkRouter(mindspore.nn.Cell):
...
class DeepseekV3MoE(mindspore.nn.Cell):
    """
...
class DeepseekV3Attention(mindspore.nn.Cell):
