...
from ...utils import is_mindspore_available, is_vision_available
...
class EfficientLoFTRImageProcessor(BaseImageProcessor):
    ...
    def post_process_keypoint_matching(
        ...
        Args:
            ...
            target_sizes (`ms.Tensor` or `List[Tuple[Tuple[int, int]]]`, *optional*):
        ...
        if isinstance(target_sizes, list):
            image_pair_sizes = mindspore.Tensor(target_sizes, )
        else:
        ...
        keypoints = keypoints.to(mindspore.int32)
        ...
        for keypoints_pair, matches, scores in zip(keypoints, outputs.matches, outputs.matching_scores):
            ...
            valid_matches = mindspore.mint.logical_and(scores > threshold, matches > -1)
    ...
    def visualize_keypoint_matching(
        self,
        images: ImageInput,
        keypoint_matching_output: list[dict[str, mindspore.Tensor]],
    ) -> list["Image.Image"]:
        """
        ...
        Args:
            ...
            outputs (List[Dict[str, ms.Tensor]]]):
