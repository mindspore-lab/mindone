...
class M2M100ScaledWordEmbedding(mint.nn.Embedding):
    """
    This module overrides torch.nn.Embeddings' forward by multiplying with embeddings scale.
    """
...
class M2M100SdpaAttention(M2M100Attention):
    def construct(
        ...
        if output_attentions or layer_head_mask is not None:
            ...
            logger.warning_once(
                "M2M100Model is using M2M100SdpaAttention, but `torch.nn.functional.scaled_dot_product_attention` does not support `output_attentions=True` or"
...
class M2M100Encoder(M2M100PreTrainedModel):
    ...
    def __init__(self, config: M2M100Config, embed_tokens: Optional[mint.nn.Embedding] = None):
