...
class MinistralAttention(nn.Cell):
...
class MinistralRMSNorm(nn.Cell):
...
class MinistralRotaryEmbedding(nn.Cell):
...
class MinistralForCausalLM(MinistralPreTrainedModel, GenerationMixin):
    ...
    def construct(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> from mindone.transformers import MinistralForCausalLM
        >>> import mindspore as ms
