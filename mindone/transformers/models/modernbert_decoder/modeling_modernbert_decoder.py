...
class ModernBertDecoderEmbeddings(nn.Cell):
    """
    ...
    def compiled_embeddings(self, input_ids: Tensor) -> Tensor:
        return self.drop(self.norm(self.tok_embeddings(input_ids)))

    def construct(self, input_ids: Optional[Tensor] = None, inputs_embeds: Optional[Tensor] = None) -> Tensor:
...
class ModernBertDecoderMLP(nn.Cell):
...
class ModernBertDecoderPredictionHead(nn.Cell):
    def __init__(self, config: ModernBertDecoderConfig):
        super().__init__()
        self.config = config
