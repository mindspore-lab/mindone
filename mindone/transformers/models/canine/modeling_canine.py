...
class CanineSelfOutput(nn.Cell):
    ...
    def construct(self, hidden_states: Tuple[ms.Tensor], input_tensor: ms.Tensor) -> Tuple[ms.Tensor, ms.Tensor]:
...
CANINE_START_DOCSTRING = r"""
    This model is a MindSpore [ms.nn.Cell](https://www.mindspore.cn/docs/zh-CN/master/api_python/nn/mindspore.nn.Cell.html?highlight=cell#mindspore.nn.Cell)
    sub-class. Use it as a regular MindSpore Cell and refer to the MindSpore documentation for all matter related to general usage and behavior.
