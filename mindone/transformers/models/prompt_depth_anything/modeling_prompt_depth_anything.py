...
class PromptDepthAnythingLayer(mindspore.nn.Cell):
    def __init__(self, config: PromptDepthAnythingConfig):
        ...
        self.convolution3 = mint.nn.Conv2d(
            config.fusion_hidden_size,
            config.fusion_hidden_size,
            kernel_size=3,
            stride=1,
...
class PromptDepthAnythingFeatureFusionLayer(mindspore.nn.Cell):
    ...
    def construct(self, hidden_state, residual=None, size=None, prompt_depth=None):
        ...
        if prompt_depth is not None:
            prompt_depth = mint.nn.functional.interpolate(
...
class PromptDepthAnythingFeatureFusionStage(mindspore.nn.Cell):
    ...
    def construct(self, hidden_states, size=None, prompt_depth=None):
