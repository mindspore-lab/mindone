    ...
    def resize_num_qa_labels(self, num_labels):
        ...
        Args:
            num_labels (`int`, *optional*):
                ...
                returns a pointer to the qa labels ``mint.nn.Linear``` module of the model without doing anything.

        Return:
            `mint.nn.Linear`: Pointer to the resized Linear layer or the old Linear layer
        """
