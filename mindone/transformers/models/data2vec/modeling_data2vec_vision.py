...
class Data2VecVisionDropPath(nn.Cell):
    """Drop paths (Stochastic Depth) per sample (when applied in main path of residual blocks)."""
...
class Data2VecVisionEmbeddings(nn.Cell):
    """
...
class Data2VecVisionPatchEmbeddings(nn.Cell):
    """
...
class Data2VecVisionSelfAttention(nn.Cell):
...
class Data2VecVisionSdpaSelfAttention(Data2VecVisionSelfAttention):
    def construct(
        ...
        if output_attentions or head_mask is not None:
            logger.warning_once(
                "`Data2VecVisionSdpaSelfAttention` is used but `scaled_dot_product_attention` does not "
...
class Data2VecVisionSelfOutput(nn.Cell):
    """
...
class Data2VecVisionAttention(nn.Cell):
    def __init__(self, config: Data2VecVisionConfig, window_size: Optional[tuple] = None) -> None:
        super().__init__()
...
class Data2VecVisionIntermediate(nn.Cell):
    def __init__(self, config: Data2VecVisionConfig) -> None:
        super().__init__()
...
class Data2VecVisionOutput(nn.Cell):
    def __init__(self, config: Data2VecVisionConfig) -> None:
        super().__init__()
...
class Data2VecVisionLayer(nn.Cell):
    ...
    def __init__(
        ...
        self.drop_path = Data2VecVisionDropPath(drop_path_rate) if drop_path_rate > 0.0 else mint.nn.Identity()
...
class Data2VecVisionRelativePositionBias(nn.Cell):
    def __init__(self, config: Data2VecVisionConfig, window_size: tuple) -> None:
        ...
        self.relative_position_bias_table = ms.Parameter(
            mint.zeros((self.num_relative_distance, config.num_attention_heads))
        )  # 2*Wh-1 * 2*Ww-1, nH
...
class Data2VecVisionEncoder(nn.Cell):
    def __init__(self, config: Data2VecVisionConfig, window_size: Optional[tuple] = None) -> None:
        super().__init__()
        self.config = config
...
class Data2VecVisionPooler(nn.Cell):
    def __init__(self, config: Data2VecVisionConfig) -> None:
        super().__init__()
        self.layernorm = (
...
class Data2VecVisionConvModule(nn.Cell):
    """
...
class Data2VecVisionPyramidPoolingBlock(nn.Cell):
...
class Data2VecVisionPyramidPoolingModule(nn.Cell):
    """
...
class Data2VecVisionUperHead(nn.Cell):
    """
...
class Data2VecVisionFCNHead(nn.Cell):
    """
