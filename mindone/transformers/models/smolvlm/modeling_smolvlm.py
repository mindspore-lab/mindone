...
class SmolVLMVisionTransformer(SmolVLMPreTrainedModel):
    ...
    def construct(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        elif not mint.any(~patch_attention_mask):
...
class SmolVLMModel(SmolVLMPreTrainedModel):
    ...
    def get_image_features(self, pixel_values: ms.Tensor, pixel_attention_mask: Optional[ms.Tensor] = None):
        """
        ...
        Args:
            ...
            pixel_attention_mask (`ms.Tensor`, *optional*):
