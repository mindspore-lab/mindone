...
class FocalNetForMaskedImageModeling(FocalNetPreTrainedModel):
    ...
    def construct(
        ...
        >>> image_processor = AutoImageProcessor.from_pretrained("microsoft/focalnet-tiny-lrf", revision="refs/pr/2")
        >>> config = FocalNetConfig()
...
class FocalNetForImageClassification(FocalNetPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        # Classifier head
        self.classifier = (
            mint.nn.Linear(self.focalnet.num_features, config.num_labels)
