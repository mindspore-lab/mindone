...
from ...utils import TensorType, is_mindspore_tensor, is_scipy_available, is_vision_available, logging
...
def max_across_indices(values: list[tuple[int, ...]]) -> list[int]:
    """
...
class YolosImageProcessor(BaseImageProcessor):
    ...
    def post_process_object_detection(
        ...
        prob = mint.nn.functional.softmax(out_logits, -1)
