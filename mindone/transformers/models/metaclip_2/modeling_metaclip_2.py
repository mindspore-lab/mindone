...
from ...utils import ModelOutput, TransformersKwargs, can_return_tuple, filter_out_non_signature_kwargs, mindspore_int
...
def contrastive_loss(logits: mindspore.Tensor) -> mindspore.Tensor:
    return mindspore.mint.nn.functional.cross_entropy(
        logits,
        mindspore.mint.arange(
            len(logits),
        ),
...
class MetaClip2ForImageClassification(MetaClip2PreTrainedModel):
    ...
    def __init__(self, config: MetaClip2Config) -> None:
        ...
        # Classifier head
        self.classifier = (
            mindspore.mint.nn.Linear(config.vision_config.hidden_size, config.num_labels)
