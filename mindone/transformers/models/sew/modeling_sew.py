...
import numpy as np
from transformers import SEWConfig, logging
...
class SEWForCTC(SEWPreTrainedModel):
    ...
    def construct(
        ...
        >>> from mindone.transformers.models.sew import SEWForCTC
...
class SEWForSequenceClassification(SEWPreTrainedModel):
    ...
    def construct(
        ...
        >>> from mindone.transformers.models.sew import SEWForSequenceClassification
        >>> from datasets import load_dataset
        >>> import mindspore as ms
