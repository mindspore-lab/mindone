...
class MistralModel(MistralPreTrainedModel):
    ...
    def _prepare_4d_causal_attention_mask_with_cache_position(
        ...
        Args:
            ...
            target_length (`int`):
                The target length: when generating with static cache, the mask should be as long as the static cache, to account for the 0 padding, the part of the cache that is not filled yet.  # noqa: E501
            dtype (`ms.Type`):
...
class MistralForCausalLM(MistralPreTrainedModel, GenerationMixin):
    ...
    def construct(
        ...
        **kwargs: Unpack[KwargsForCausalLM],
        ...
        >>> from mindone.transformers import MistralForCausalLM
        >>> import mindspore as ms
