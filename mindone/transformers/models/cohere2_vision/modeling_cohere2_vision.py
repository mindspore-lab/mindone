...
class Cohere2VisionMultiModalProjector(nn.Cell):
    def __init__(self, config: Cohere2VisionConfig):
        ...
        self.linear_2 = mint.nn.Linear(self.intermediate_size // 2, config.text_config.hidden_size, bias=True)
...
class Cohere2VisionForConditionalGeneration(Cohere2VisionPreTrainedModel, GenerationMixin):
    ...
    def construct(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from mindone.transformers import AutoProcessor, Cohere2VisionForConditionalGeneration
