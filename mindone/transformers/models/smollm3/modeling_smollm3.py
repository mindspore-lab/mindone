...
class SmolLM3Attention(nn.Cell):
...
class SmolLM3RotaryEmbedding(nn.Cell):
...
class SmolLM3ForCausalLM(SmolLM3PreTrainedModel, GenerationMixin):
    ...
    def construct(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> from mindone.transformers import SmolLM3ForCausalLM
        >>> import mindspore as ms
