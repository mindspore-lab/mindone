...
from transformers.models.roberta_prelayernorm.configuration_roberta_prelayernorm import RobertaPreLayerNormConfig
...
class RobertaPreLayerNormEmbeddings(nn.Cell):
    """
...
class RobertaPreLayerNormSelfAttention(nn.Cell):
...
class RobertaPreLayerNormSelfOutput(nn.Cell):
    def __init__(self, config):
        super().__init__()
...
class RobertaPreLayerNormAttention(nn.Cell):
    def __init__(self, config, position_embedding_type=None):
        super().__init__()
...
class RobertaPreLayerNormIntermediate(nn.Cell):
    def __init__(self, config):
        super().__init__()
        self.LayerNorm = mint.nn.LayerNorm(config.hidden_size, eps=config.layer_norm_eps)
...
class RobertaPreLayerNormOutput(nn.Cell):
    def __init__(self, config):
        super().__init__()
...
class RobertaPreLayerNormLayer(nn.Cell):
    def __init__(self, config):
        super().__init__()
...
class RobertaPreLayerNormEncoder(nn.Cell):
    def __init__(self, config):
        super().__init__()
        self.config = config
        self.layer = nn.CellList([RobertaPreLayerNormLayer(config) for _ in range(config.num_hidden_layers)])
...
class RobertaPreLayerNormPooler(nn.Cell):
    def __init__(self, config):
        super().__init__()
        self.dense = mint.nn.Linear(config.hidden_size, config.hidden_size)
...
# FacebookAI/roberta-base->andreasmadsen/efficient_mlm_m0.40,ROBERTA->ROBERTA_PRELAYERNORM,
# Roberta->RobertaPreLayerNorm,roberta->roberta_prelayernorm, RobertaPreLayerNormTokenizer->RobertaTokenizer
class RobertaPreLayerNormForCausalLM(RobertaPreLayerNormPreTrainedModel, GenerationMixin):
    ...
    def construct(
        ...
        **kwargs,
        ...
        >>> from mindone.transformers import RobertaPreLayerNormForCausalLM
        >>> import mindspore as ms
        >>> import numpy as np
...
class RobertaPreLayerNormForMaskedLM(RobertaPreLayerNormPreTrainedModel):
    ...
    # Copied from transformers.models.roberta.modeling_roberta.RobertaForMaskedLM.__init__ with
    # ROBERTA->ROBERTA_PRELAYERNORM,Roberta->RobertaPreLayerNorm,roberta->roberta_prelayernorm
    def __init__(self, config):
        super().__init__(config)
    ...
    # Copied from transformers.models.roberta.modeling_roberta.RobertaForMaskedLM.construct
    # with ROBERTA->ROBERTA_PRELAYERNORM,Roberta->RobertaPreLayerNorm,roberta->roberta_prelayernorm
    def construct(
        self,
        input_ids: Optional[ms.Tensor] = None,
        attention_mask: Optional[ms.Tensor] = None,
...
class RobertaPreLayerNormLMHead(nn.Cell):
...
class RobertaPreLayerNormForSequenceClassification(RobertaPreLayerNormPreTrainedModel):
    ...
    # Copied from transformers.models.roberta.modeling_roberta.RobertaForSequenceClassification.construct with roberta->roberta_prelayernorm
    def construct(
        self,
        input_ids: Optional[ms.Tensor] = None,
        attention_mask: Optional[ms.Tensor] = None,
...
class RobertaPreLayerNormForTokenClassification(RobertaPreLayerNormPreTrainedModel):
    ...
    # Copied from transformers.models.roberta.modeling_roberta.RobertaForTokenClassification.construct with roberta->roberta_prelayernorm
    def construct(
        self,
        input_ids: Optional[ms.Tensor] = None,
        attention_mask: Optional[ms.Tensor] = None,
...
class RobertaPreLayerNormClassificationHead(nn.Cell):
...
class RobertaPreLayerNormForQuestionAnswering(RobertaPreLayerNormPreTrainedModel):
    ...
    # Copied from transformers.models.roberta.modeling_roberta.RobertaForQuestionAnswering.construct with roberta->roberta_prelayernorm
    def construct(
        self,
        input_ids: Optional[ms.Tensor] = None,
        attention_mask: Optional[ms.Tensor] = None,
