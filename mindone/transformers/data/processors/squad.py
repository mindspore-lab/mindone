...
def squad_convert_examples_to_features(
    ...
    if return_dataset == "ms":
        ...
        all_attention_masks = ms.tensor([f.attention_mask for f in features], dtype=ms.int64)
        all_token_type_ids = ms.tensor([f.token_type_ids for f in features], dtype=ms.int64)
        all_cls_index = ms.tensor([f.cls_index for f in features], dtype=ms.int64)
        all_p_mask = ms.tensor([f.p_mask for f in features], dtype=ms.float32)
