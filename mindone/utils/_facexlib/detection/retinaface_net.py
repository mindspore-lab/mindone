...
class MobileNetV1(nn.Cell):
    def __init__(self):
        ...
        self.avg = mint.nn.AdaptiveAvgPool2d((1, 1))
        self.fc = mint.nn.Linear(256, 1000)
...
def make_landmark_head(fpn_num=3, inchannels=64, anchor_num=2):
    ...
    return nn.CellList(landmarkhead)
