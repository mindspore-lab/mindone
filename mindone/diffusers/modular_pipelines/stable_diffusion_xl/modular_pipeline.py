...
SDXL_INPUTS_SCHEMA = {
    ...
    "generator": InputParam(
        "generator",
        type_hint=Optional[Union[np.random.Generator, List[np.random.Generator]]],
    ...
    "timesteps": InputParam(
        "timesteps", type_hint=Optional[ms.Tensor], description="Custom timesteps for the denoising process"
    ),
    "sigmas": InputParam(
        "sigmas", type_hint=Optional[ms.Tensor], description="Custom sigmas for the denoising process"
    ),
    ...
    "latents": InputParam(
        "latents", type_hint=Optional[ms.Tensor], description="Pre-generated noisy latents for image generation"
    ),
    ...
    "negative_prompt_embeds": InputParam(
        "negative_prompt_embeds", type_hint=ms.Tensor, description="Negative text embeddings"
    ),
    "pooled_prompt_embeds": InputParam(
        "pooled_prompt_embeds", type_hint=ms.Tensor, required=True, description="Pooled text embeddings"
    ),
    "negative_pooled_prompt_embeds": InputParam(
        "negative_pooled_prompt_embeds", type_hint=ms.Tensor, description="Negative pooled text embeddings"
    ),
    "batch_size": InputParam("batch_size", type_hint=int, required=True, description="Number of prompts"),
    "dtype": InputParam("dtype", type_hint=ms.Type, description="Data type of model tensor inputs"),
    ...
    "latent_timestep": InputParam(
        "latent_timestep", type_hint=ms.Tensor, required=True, description="Initial noise level timestep"
    ),
    "image_latents": InputParam(
        "image_latents", type_hint=ms.Tensor, required=True, description="Latents representing reference image"
    ),
    "mask": InputParam("mask", type_hint=ms.Tensor, required=True, description="Mask for inpainting"),
    "masked_image_latents": InputParam(
        "masked_image_latents", type_hint=ms.Tensor, description="Masked image latents for inpainting"
    ),
    "add_time_ids": InputParam(
        "add_time_ids", type_hint=ms.Tensor, required=True, description="Time ids for conditioning"
    ),
    "negative_add_time_ids": InputParam("negative_add_time_ids", type_hint=ms.Tensor, description="Negative time ids"),
    "timestep_cond": InputParam("timestep_cond", type_hint=ms.Tensor, description="Timestep conditioning for LCM"),
    "noise": InputParam("noise", type_hint=ms.Tensor, description="Noise added to image latents"),
    ...
    "ip_adapter_embeds": InputParam(
        "ip_adapter_embeds", type_hint=List[ms.Tensor], description="Image embeddings for IP-Adapter"
    ),
    ...
    "images": InputParam(
        "images",
        type_hint=Union[List[PIL.Image.Image], List[ms.Tensor], List[np.array]],
        required=True,
...
SDXL_INTERMEDIATE_OUTPUTS_SCHEMA = {
    "prompt_embeds": OutputParam(
        "prompt_embeds", type_hint=ms.Tensor, description="Text embeddings used to guide image generation"
    ),
    "negative_prompt_embeds": OutputParam(
        "negative_prompt_embeds", type_hint=ms.Tensor, description="Negative text embeddings"
    ),
    "pooled_prompt_embeds": OutputParam(
        "pooled_prompt_embeds", type_hint=ms.Tensor, description="Pooled text embeddings"
    ),
    "negative_pooled_prompt_embeds": OutputParam(
        "negative_pooled_prompt_embeds", type_hint=ms.Tensor, description="Negative pooled text embeddings"
    ),
    "batch_size": OutputParam("batch_size", type_hint=int, description="Number of prompts"),
    "dtype": OutputParam("dtype", type_hint=ms.Type, description="Data type of model tensor inputs"),
    "image_latents": OutputParam(
        "image_latents", type_hint=ms.Tensor, description="Latents representing reference image"
    ),
    "mask": OutputParam("mask", type_hint=ms.Tensor, description="Mask for inpainting"),
    ...
    "timesteps": OutputParam("timesteps", type_hint=ms.Tensor, description="Timesteps for inference"),
    "num_inference_steps": OutputParam("num_inference_steps", type_hint=int, description="Number of denoising steps"),
    "latent_timestep": OutputParam("latent_timestep", type_hint=ms.Tensor, description="Initial noise level timestep"),
    "add_time_ids": OutputParam("add_time_ids", type_hint=ms.Tensor, description="Time ids for conditioning"),
    "negative_add_time_ids": OutputParam("negative_add_time_ids", type_hint=ms.Tensor, description="Negative time ids"),
    "timestep_cond": OutputParam("timestep_cond", type_hint=ms.Tensor, description="Timestep conditioning for LCM"),
    "latents": OutputParam("latents", type_hint=ms.Tensor, description="Denoised latents"),
    "noise": OutputParam("noise", type_hint=ms.Tensor, description="Noise added to image latents"),
...
SDXL_OUTPUTS_SCHEMA = {
    "images": OutputParam(
        "images",
        type_hint=Union[
            Tuple[Union[List[PIL.Image.Image], List[ms.Tensor], List[np.array]]], StableDiffusionXLPipelineOutput
        ],
