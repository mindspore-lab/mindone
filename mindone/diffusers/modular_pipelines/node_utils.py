...
SDXL_INTERMEDIATE_INPUTS_SCHEMA = {
    ...
    "latents": InputParam(
        "latents", type_hint=ms.Tensor, required=True, description="Initial latents for denoising process"
    ),
    "timesteps": InputParam("timesteps", type_hint=ms.Tensor, required=True, description="Timesteps for inference"),
    "num_inference_steps": InputParam(
