...
def repeat_tensor_to_batch_size(
    ...
    Returns:
        ms.Tensor: The repeated tensor with final batch size (batch_size * num_images_per_prompt)
...
def calculate_dimension_from_latents(latents: ms.Tensor, vae_scale_factor: int) -> Tuple[int, int]:
