...
class QwenImageInpaintInputStep(SequentialPipelineBlocks):
    ...
    def description(self):
        return (
            ...
            " (`image_latents` and `processed_mask_image`).\n"
...
class QwenImageInpaintDecodeStep(SequentialPipelineBlocks):
    ...
    def description(self):
        return (
            "Decode step that decodes the latents to images and postprocess the generated image, optional apply"
            " the mask overally to the original image."
        )
