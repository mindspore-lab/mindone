...
MODULAR_PIPELINE_MAPPING = OrderedDict(
    [
        ...
        ("qwenimage-edit", "QwenImageEditPlusModularPipeline"),
    ]
)
...
# 3. imnprove docstring and potentially add validator for methods where we accpet kwargs to be passed to
# from_pretrained/save_pretrained/load_default_components(), load_components()
