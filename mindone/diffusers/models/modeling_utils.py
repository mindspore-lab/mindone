    ...
    def to(self, dtype: Optional[ms.Type] = None):
        for _, cell in self.cells_and_names():
            for param_name, param in cell._params.items():
                _param_info = param.param_info
                new_param = ms.Parameter(param.to(dtype))
                new_param.param_info = _param_info
                param.param_info = None
                setattr(cell, param_name, new_param)
