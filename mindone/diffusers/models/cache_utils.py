...
class CacheMixin:
    ...
    Supported caching techniques:
        ...
        - [FirstBlockCache]
        (https://github.com/chengzeyi/ParaAttention/blob/7a266123671b55e7e5a2fe9af3121f07a36afc78/README.md#first-block-cache-our-dynamic-caching)
    """
    ...
    def enable_cache(self, config) -> None:
        ...
        >>> from mindone.diffusers import CogVideoXPipeline, PyramidAttentionBroadcastConfig
