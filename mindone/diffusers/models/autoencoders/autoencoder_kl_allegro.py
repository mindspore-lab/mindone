...
class AllegroDownBlock3D(nn.Cell):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
...
class AllegroUpBlock3D(nn.Cell):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
...
class AllegroMidBlock3DConv(nn.Cell):
    def __init__(
        self,
        in_channels: int,
        temb_channels: int,
...
class AllegroEncoder3D(nn.Cell):
    def __init__(
        self,
        in_channels: int = 3,
        out_channels: int = 3,
...
class AllegroDecoder3D(nn.Cell):
    def __init__(
        self,
        in_channels: int = 4,
        out_channels: int = 3,
