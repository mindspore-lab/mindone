...
class AutoencoderKLFlux2(ModelMixin, AutoencoderMixin, ConfigMixin, FromOriginalModelMixin, PeftAdapterMixin):
    ...
    def decode(self, z: ms.Tensor, return_dict: bool = True, generator=None) -> Union[DecoderOutput, ms.Tensor]:
        """
    ...
    def tiled_encode(self, x: ms.Tensor, return_dict: bool = True) -> AutoencoderKLOutput:
        r"""Encode a batch of images using a tiled encoder.
