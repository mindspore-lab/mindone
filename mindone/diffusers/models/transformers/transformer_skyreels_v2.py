...
def _get_qkv_projections(attn: "SkyReelsV2Attention", hidden_states: ms.Tensor, encoder_hidden_states: ms.Tensor):
...
def _get_added_kv_projections(attn: "SkyReelsV2Attention", encoder_hidden_states_img: ms.Tensor):
    if attn.fused_projections:
...
class SkyReelsV2Attention(ms.nn.Cell, AttentionModuleMixin):
