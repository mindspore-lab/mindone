...
CROSS_ATTENTION_PROCESSORS = (AttnProcessor, IPAdapterAttnProcessor)

AttentionProcessor = Union[AttnProcessor, AttnAddedKVProcessor, CustomDiffusionAttnProcessor]  # noqa: E231
