...
class StableDiffusionXLKolorsPipeline(DiffusionPipeline, FromSingleFileMixin, LoraLoaderMixin):
    r"""
    ...
    def encode_prompt(
        ...
        if prompt_embeds is None:
            ...
            for tokenizer, text_encoder in zip(tokenizers, text_encoders):
                ...
                prompt_embeds = output[2][-2].permute(1, 0, 2).copy()  # [batch_size, 77, 4096]
                text_proj = output[2][-1][-1, :, :].copy()  # [batch_size, 4096]
        ...
        if do_classifier_free_guidance and negative_prompt_embeds is None and zero_out_negative_prompt:
            ...
            for tokenizer, text_encoder in zip(tokenizers, text_encoders):
                ...
                negative_prompt_embeds = output[2][-2].permute(1, 0, 2).copy()  # [batch_size, 77, 4096]
                negative_text_proj = output[2][-1][-1, :, :].copy()  # [batch_size, 4096]
        ...
        text_proj = text_proj.tile((1, num_images_per_prompt)).view(bs_embed * num_images_per_prompt, -1)
        negative_text_proj = negative_text_proj.tile((1, num_images_per_prompt)).view(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if do_classifier_free_guidance:
                    ...
                    #     noise_pred = DynamicThresh.dynthresh(noise_pred_text, noise_pred_uncond, guidance_scale, None)
