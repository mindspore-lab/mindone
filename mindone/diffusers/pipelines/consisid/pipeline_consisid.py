...
from ...utils import is_opencv_available, logging, scale_lora_layers, unscale_lora_layers
...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        ...     eva_transform_mean,
        ...     eva_transform_std,
        ... ) = prepare_face_models("townwish/ConsisID-Face-Models", dtype=mindspore.bfloat16)
        >>> pipe = ConsisIDPipeline.from_pretrained("BestWishYsh/ConsisID-preview", mindspore_dtype=mindspore.bfloat16)

        >>> # ConsisID works well with long and well-described prompts. Make sure the face in the image is clearly visible (e.g., preferably half-body or full-body).  # noqa: E501
        >>> prompt = "The video captures a boy walking along a city street, filmed in black and white on a classic 35mm camera. His expression is thoughtful, his brow slightly furrowed as if he's lost in contemplation. The film grain adds a textured, timeless quality to the image, evoking a sense of nostalgia. Around him, the cityscape is filled with vintage buildings, cobblestone sidewalks, and softly blurred figures passing by, their outlines faint and indistinct. Streetlights cast a gentle glow, while shadows play across the boy's path, adding depth to the scene. The lighting highlights the boy's subtle smile, hinting at a fleeting moment of curiosity. The overall cinematic atmosphere, complete with classic film still aesthetics and dramatic contrasts, gives the scene an evocative and introspective feel."  # noqa: E501
