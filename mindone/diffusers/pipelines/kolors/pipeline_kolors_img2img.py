...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> prompt = ("high quality image of a capybara wearing sunglasses. In the background of the image there are trees, poles, grass and other objects. "
                      "At the bottom of the object there is the road., 8k, highly detailed.")
