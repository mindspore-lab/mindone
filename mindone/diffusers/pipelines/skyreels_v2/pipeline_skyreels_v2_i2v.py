...
from mindone.transformers import CLIPVisionModelWithProjection, UMT5EncoderModel
...
class SkyReelsV2ImageToVideoPipeline(DiffusionPipeline, SkyReelsV2LoraLoaderMixin):
    ...
    def prepare_latents(
        ...
        if isinstance(generator, list):
            latent_condition = [
                retrieve_latents(self.vae, self.vae.encode(video_condition)[0], sample_mode="argmax") for _ in generator
            ]
