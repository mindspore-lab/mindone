...
class StableDiffusionLatentUpscalePipeline(DiffusionPipeline, FromSingleFileMixin):
    ...
    def _encode_prompt(self, prompt, do_classifier_free_guidance, negative_prompt):
        ...
        if do_classifier_free_guidance:
            ...
            uncond_embeddings = uncond_encoder_out[0][-1]
    ...
    def __call__(
        ...
        image_cond = ops.interpolate(image, scale_factor=2.0, mode="nearest", recompute_scale_factor=True) * inv_noise_level[:, None, None, None]
