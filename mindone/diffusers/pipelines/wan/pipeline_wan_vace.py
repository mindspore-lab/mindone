...
def retrieve_latents(
    encoder_output: ms.Tensor, generator: Optional[ms.Generator] = None, sample_mode: str = "sample"
):
...
class WanVACEPipeline(DiffusionPipeline, WanLoraLoaderMixin):
    ...
    def prepare_video_latents(
        ...
        latents_mean = ms.tensor(self.vae.config.latents_mean, dtype=ms.float32).view(
    ...
    def prepare_latents(
        ...
        width: int = 832,
        num_frames: int = 81,
        dtype: Optional[mint.dtype] = None,
        generator: Optional[Union[ms.Generator, List[ms.Generator]]] = None,
