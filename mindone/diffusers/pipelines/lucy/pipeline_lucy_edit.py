...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> from mindone.diffusers import AutoencoderKLWan, LucyEditPipeline
        ...
        >>> prompt = "Change the apron and blouse to a classic clown costume: "
                    "satin polka-dot jumpsuit in bright primary colors, ruffled white collar, oversized pom-pom buttons, "
                    "white gloves, oversized red shoes, red foam nose; soft window light from left, "
        ...
        >>> pipe = LucyEditPipeline.from_pretrained(model_id, vae=vae, mindspore_dtype=ms.bfloat16)
