"""Adapted from https://github.com/huggingface/diffusers/tree/main/src/diffusers/pipelines/cogvideo/__init__.py."""
...
_import_structure = {
    ...
    "pipeline_cogvideox_fun_control": ["CogVideoXFunControlPipeline"],
