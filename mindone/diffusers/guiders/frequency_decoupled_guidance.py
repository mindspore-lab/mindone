...
_CAN_USE_KORNIA = False
upsample_and_blur_func = None
build_laplacian_pyramid_func = None


def project(v0: ms.Tensor, v1: ms.Tensor, upcast_to_double: bool = True) -> Tuple[ms.Tensor, ms.Tensor]:
    """
    ...
    v1 = mint.nn.functional.normalize(v1, dim=all_dims_but_first)
