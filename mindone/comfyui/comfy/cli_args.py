...
parser.add_argument(
    "--output-directory", type=str, default=None, help="Set the ComfyUI output directory. Overrides --base-directory."
)
parser.add_argument(
    "--temp-directory",
    type=str,
...
parser.add_argument(
    "--input-directory", type=str, default=None, help="Set the ComfyUI input directory. Overrides --base-directory."
)
...
parser.add_argument(
    "--supports-fp8-compute", action="store_true", help="ComfyUI will act like if the device supports fp8 compute."
)
...
attn_group.add_argument(
    "--use-mindspore-cross-attention", action="store_true", help="Use the mindspore cross attention function."
)
...
vram_group.add_argument(
    "--gpu-only", action="store_true", help="Store and run everything (text encoders/CLIP models, etc... on the GPU)."
)
vram_group.add_argument(
    "--highvram",
    action="store_true",
...
parser.add_argument(
    "--deterministic",
    action="store_true",
    help="Make mindspore use slower deterministic algorithms when it can. Note that this might not make images deterministic in all cases.",
)
...
parser.add_argument(
    "--log-stdout", action="store_true", help="Send normal process output to stdout instead of stderr (default)."
)
