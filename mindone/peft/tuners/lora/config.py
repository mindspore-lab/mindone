...
from mindone.peft.utils import PeftType
...
class LoraConfig(PeftConfig):
    ...
    Args:
        ...
        layers_pattern (`Optional[Union[List[str], str]]`):
            ...
            `nn.CellList` of the model, which is often called `'layers'` or `'h'`.
        rank_pattern (`dict`):
    ...
    layers_to_transform: Optional[Union[list[int], int]] = field(
        default=None,
        metadata={
            "help": "The layer indexes to transform, is this argument is specified, PEFT will transform only the layers indexes that are specified inside this list. If a single integer is passed, PEFT will transform only the layer at this index. "  # noqa: E501
    ...
    layers_pattern: Optional[Union[list[str], str]] = field(
        default=None,
        metadata={
            "help": "The layer pattern name, used only if `layers_to_transform` is different to None and if the layer pattern is not in the common layers pattern."  # noqa: E501
            "This only works when target_modules is a list of str. This should target the `nn.CellList` of the "
    ...
    use_dora: bool = field(
        ...
        metadata={
            "help": (
                "Enable <a href='https://arxiv.org/abs/2402.09353'>'Weight-Decomposed Low-Rank Adaptation' (DoRA)</a>. This technique decomposes the updates of the "  # noqa: E501
    ...
    def __post_init__(self):
        ...
        self._custom_modules: Optional[dict[type[nn.Cell], type[nn.Cell]]] = None

    def _register_custom_module(self, mapping: dict[type[nn.Cell], type[nn.Cell]]) -> None:
        """
        ...
        multiple layer types. The target layer type can be any nn.Cell that we currently don't support in PEFT,
