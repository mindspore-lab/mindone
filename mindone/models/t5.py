...
from .modules.mininlp.configs import HF_CONFIG_URL_BASE
from .modules.mininlp.pretrained_config import PreTrainedConfig
from .modules.mininlp.activations import ACT2FN
from .modules.mininlp.configs import MINDNLP_MODEL_URL_BASE
from .modules.mininlp.legacy import Dropout, arange
from .modules.mininlp.pretrained_model import PreTrainedModel
...
CONFIG_ARCHIVE_MAP = {model: HF_CONFIG_URL_BASE.format(model) for model in T5_SUPPORT_LIST}
...
def get_t5_encoder(cache_folder, trainable=False):
    ...
    pretrained_model = os.path.join(cache_folder, "ms_model.ckpt")
    if os.path.exists(pretrained_model):
        param_dict = ms.load_checkpoint(pretrained_model)
